...
export class HistoryModel {
  ...
  constructor(history: HistoricalPrice, mpid: string | number, refTime: Date, apiResponseLinkedId: any) {
    ...
    this.MinQty = typeof history.minQty === "string" ? parseInt(history.minQty) : history.minQty;
    this.Position = typeof history.rank === "string" ? parseInt(history.rank) : history.rank;
    this.LowestVendor = history.lowestVendor;
    this.LowestPrice = history.lowestPrice === "N/A" ? null : typeof history.lowestPrice === "string" ? parseFloat(history.lowestPrice) : history.lowestPrice;
    this.SuggestedPrice = history.suggestedPrice === "N/A" ? null : typeof history.suggestedPrice === "string" ? parseFloat(history.suggestedPrice) : history.suggestedPrice;
    this.RepriceComment = history.repriceComment;
    this.MaxVendor = history.maxVendor;
    this.MaxVendorPrice = history.maxVendorPrice === "N/A" ? null : typeof history.maxVendorPrice === "string" ? parseFloat(history.maxVendorPrice) : history.maxVendorPrice;
