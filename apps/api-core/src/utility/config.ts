...
const envSchema = z.object({
  ...
  SQL_SP_GET_REGULAR_CRON_PRODUCTS_BY_CRON: z
    .string()
    .default("sp_GetActiveFullProductDetailsListByCronV4"),
  SQL_SP_GET_SLOW_CRON_PRODUCTS_BY_CRON: z
    .string()
    .default("sp_GetActiveFullProductDetailsListBySlowCronV4"),
  ...
  SQL_SP_FILTER_ELIGIBLE_PRODUCT: z
    .string()
    .default("sp_GetFilterEligibleProductsByFilterDateV4"),
  // App
