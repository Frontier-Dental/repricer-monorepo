...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsListByFilterV2;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsListByFilterV2 (IN pageNumber int, IN pageSize int) BEGIN DECLARE _skipNo Int;
