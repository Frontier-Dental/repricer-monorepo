...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsListByTagV2;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsListByTagV2 (IN tagValue varchar(50)) BEGIN DECLARE _searchKey varchar(50);
