...
DROP PROCEDURE IF EXISTS sp_GetActiveFullProductDetailsListByCronV4;

delimiter / /
CREATE PROCEDURE sp_GetActiveFullProductDetailsListByCronV4 (IN cronId varchar(50)) BEGIN
