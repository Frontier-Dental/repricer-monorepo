...
DROP PROCEDURE IF EXISTS sp_GetActiveFullProductDetailsListBySlowCronV4;

delimiter / /
CREATE PROCEDURE sp_GetActiveFullProductDetailsListBySlowCronV4 (IN cronId varchar(50)) BEGIN
