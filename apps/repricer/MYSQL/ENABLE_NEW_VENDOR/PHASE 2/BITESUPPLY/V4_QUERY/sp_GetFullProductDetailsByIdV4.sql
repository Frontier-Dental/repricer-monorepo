...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsByIdV4;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsByIdV4 (IN mpid int) BEGIN DECLARE _mpid Int;
