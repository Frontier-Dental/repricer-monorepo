...
DROP PROCEDURE IF EXISTS sp_UpsertProductDetailsV4;

delimiter / /
CREATE PROCEDURE sp_UpsertProductDetailsV4 (
  IN _mpid int,
  IN _active boolean,
  IN _url varchar(555),
...
ON DUPLICATE KEY UPDATE
  ...
  LinkedBiteSupplyDetailsInfo = _biteSupplyLink;
