...
DROP PROCEDURE IF EXISTS sp_GetActiveFullProductDetailsListByCronV3;

delimiter / /
CREATE PROCEDURE sp_GetActiveFullProductDetailsListByCronV3 (IN cronId varchar(50)) BEGIN
  ...
  (
    ...
    (
      ...
      WHERE
        pl.RegularCronId = cronId
        AND pl.IsSlowActivated != TRUE
        AND triadDl.ChannelName IS NOT NULL
