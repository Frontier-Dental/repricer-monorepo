...
DROP PROCEDURE IF EXISTS sp_GetFilterEligibleProductsByFilterDateV3;

delimiter / /
CREATE PROCEDURE sp_GetFilterEligibleProductsByFilterDateV3 (IN filterDate VARCHAR(50)) BEGIN
