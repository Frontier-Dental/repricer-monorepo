...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsListByFilterV3;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsListByFilterV3 (IN pageNumber int, IN pageSize int) BEGIN DECLARE _skipNo Int;
