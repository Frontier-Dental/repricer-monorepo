...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsListByTagV3;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsListByTagV3 (IN tagValue varchar(50)) BEGIN DECLARE _searchKey varchar(50);
...
/**Creates temporary table for all available MpIds along with their RunIds for RunInfo*/
