...
CREATE TABLE "table_firstDentDetails" (
  ...
  PRIMARY KEY ("Id"),
  UNIQUE KEY "unique_idx_firstdent_mpid" ("MpId"),
  KEY "idx_item_firstdent_activated" ("Activated"),
  KEY "idx_item_firstdent_mpid" ("MpId")
);
