...
DROP PROCEDURE IF EXISTS sp_GetActiveFullProductDetailsListBySlowCron;

delimiter / /
CREATE PROCEDURE sp_GetActiveFullProductDetailsListBySlowCron (IN cronId varchar(50)) BEGIN
