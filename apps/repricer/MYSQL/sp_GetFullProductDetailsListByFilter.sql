...
DROP PROCEDURE IF EXISTS sp_GetFullProductDetailsListByFilter;

delimiter / /
CREATE PROCEDURE sp_GetFullProductDetailsListByFilter (IN pageNumber int, IN pageSize int) BEGIN DECLARE _skipNo Int;
