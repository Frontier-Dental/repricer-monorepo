...
DROP PROCEDURE IF EXISTS sp_GetLastScrapeDetailsById;

delimiter / /
CREATE PROCEDURE sp_GetLastScrapeDetailsById (IN productId varchar(16383)) BEGIN DECLARE time_value varchar(25);
