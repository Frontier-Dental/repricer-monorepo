...
DROP PROCEDURE IF EXISTS sp_GetScrapeDetailsByIdAndDateRange;

delimiter / /
CREATE PROCEDURE sp_GetScrapeDetailsByIdAndDateRange (
  IN productId varchar(16383),
...
-- Loop through Start Date and End Date to insert the available dates in the Temporary Table
