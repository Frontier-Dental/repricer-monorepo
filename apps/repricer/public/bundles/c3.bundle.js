  ...
  return (
          ...
          (n.prototype.parseSegment = function () {
            ...
            switch ((this._previousCommand = e)) {
              ...
              case window.SVGPathSeg.PATHSEG_CLOSEPATH:
                return (
                  this._skipOptionalSpaces(),
                  new window.SVGPathSegClosePath(i)
                );
    ...
    (y.xgrids = function (t) {
      var e = this.internal,
        n = e.config;
      return (
        t && ((n.grid_x_lines = t), e.redrawWithoutRescale()),
        n.grid_x_lines
      );
    }),
    ...
    (y.ygrids = function (t) {
      var e = this.internal,
        n = e.config;
      return (
        t && ((n.grid_y_lines = t), e.redrawWithoutRescale()),
        n.grid_y_lines
      );
    }),
    ...
    (m.classTarget = function (t) {
      ...
      return (
        e && (n = " " + X.target + "-" + e),
        this.generateClass(X.target, t) + n
      );
    }),
    ...
    (m.getCurrentPaddingTop = function () {
      ...
      return (
        this.title && this.title.node() && (e += this.getTitlePadding()),
        e
      );
    }),
    ...
    (m.initBrush = function () {
      ...
      ((e.brush = t.svg.brush().on("brush", function () {
        ...
        (e.brush.update = function () {
          return (
            e.context && e.context.select("." + X.brush).call(this),
            this
          );
        }),
    ...
    (m.getDefaultExtent = function () {
      var t = this,
        ...
        n = h(e.axis_x_extent)
          ...
          : e.axis_x_extent;
      return (
        t.isTimeSeries() && (n = [t.parseDate(n[0]), t.parseDate(n[1])]),
        n
      );
    }),
    (m.initText = function () {
    ...
    ((Qa.year = Vt(
      ...
      [
        ...
        var e = (Qa[t] = Vt(
          function (t) {
            return (
              (t = Qa.day(t)).setDate(t.getDate() - ((t.getDay() + n) % 7)),
              t
            );
          },
          function (t, e) {
                ...
                (u =
                  "squarify" !== x || (i = d(o, c)) <= u
                    ...
                    : ((o.area -= o.pop().area),
                      ...
                      (o.length = o.area = 0),
                      1 / 0)));
            (o.length && (f(o, c, a, !0), (o.length = o.area = 0)),
              e.forEach(h));
          }
        }
        function o(t) {
