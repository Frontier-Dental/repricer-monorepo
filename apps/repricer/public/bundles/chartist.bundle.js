    ...
    (function (t, e, s) {
      ...
      ((s.Svg.Path = s.Class.extend({
        ...
        move: function (t, e, i, n) {
          return (
            u("M", { x: +t, y: +e }, this.pathElements, this.pos++, i, n),
            this
          );
        },
        line: function (t, e, i, n) {
          return (
            u("L", { x: +t, y: +e }, this.pathElements, this.pos++, i, n),
            this
          );
        },
                ...
                s.addEventListener("click", function (t) {
                  ...
                  if (e.parentNode === s && e.hasAttribute("data-legend")) {
                    ...
                    var i = parseInt(e.getAttribute("data-legend")),
                      n = l.indexOf(i);
                    if (-1 < n)
                      (l.splice(n, 1), e.classList.remove("inactive"));
                    else if (h.removeAll)
            ...
            ((e = this),
              (i = function () {
                ...
                function v(t) {
                  var e = g(NaN);
                  return (
                    null != t ? c(p(e), t) : (p(e).userInvalidated = !0),
                    e
                  );
                }
                function r(t) {
                ...
                (a.controllers.line = a.DatasetController.extend({
                  ...
                  addElementAndReset: function (t) {
                    var e = this,
                      i = e.chart.options,
                      n = e.getMeta();
                    (a.DatasetController.prototype.addElementAndReset.call(
                      e,
                      t,
                    ),
                      f(e.getDataset(), i) &&
                          ...
                          if (null != t) {
                            ...
                            if (
                              ...
                              (void 0 !== x.zeroLineIndex ? x.zeroLineIndex : 0)
                                ? ((n = _.zeroLineWidth), (a = _.zeroLineColor))
                                : ((n = Y.getValueAtIndexOrDefault(
                                    _.lineWidth,
                                    e,
                                  )),
                                  (a = Y.getValueAtIndexOrDefault(_.color, e)));
                              var p,
                                m = "middle";
                              if (C) {
                                (M ||
                                ...
                                "left" === w.position
                                  ? S.mirror
                                    ? ((f = x.right + S.padding), (p = "left"))
                                    : ((f = x.right - S.padding), (p = "right"))
                                  : S.mirror
                                    ? ((f = x.left - S.padding), (p = "right"))
                                    : ((f = x.left + S.padding), (p = "left"));
                ...
                i = t.Scale.extend({
                  ...
                  getValueForPixel: function (t) {
                    var e,
                      i,
                      n = this,
                      a = d.log10(n.end) - d.log10(n.start);
                    return (
                      n.isHorizontal()
                        ? ((i = n.width - (n.paddingLeft + n.paddingRight)),
                          (e =
                            ...
                            Math.pow(
                              10,
                              ((t - n.left - n.paddingLeft) * a) / i,
                            )))
                        : ((i = n.height - (n.paddingTop + n.paddingBottom)),
                          (e =
                            Math.pow(
                              10,
                              ((n.bottom - n.paddingBottom - t) * a) / i,
                            ) / n.start)),
                      e
                    );
                  },
                ...
                var x = b.helpers,
                  ...
                  t = b.Scale.extend({
                    ...
                    buildTicks: function () {
                      ...
                      if (
                        (n.options.time.min
                          ? (t = n.getMomentStartOf(n.firstTick))
