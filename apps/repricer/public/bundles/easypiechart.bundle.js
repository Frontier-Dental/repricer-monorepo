(!(function (e, t) {
      ...
      var s = function (e, t, n) {
        ...
        u = function () {
          (o.scaleColor &&
            ...
            o.trackColor && s(o.trackColor, o.trackWidth || o.lineWidth, 1));
        };
          ...
          (o.scaleColor || o.trackColor
            ? i.getImageData && i.putImageData
              ? n
                ...
                : (u(), (n = i.getImageData(0, 0, o.size * a, o.size * a)))
              : (this.clear(), u())
            : this.clear(),
            (i.lineCap = o.lineCap),
  ...
  (function (a) {
    ...
    ((e.prototype.init = function () {
      a(".easy-pie-chart-1").easyPieChart({
        ...
        onStep: function (e, t, n) {
          a(this.el).find(".percent").text(Math.round(n));
        },
      });
    }),
      (a.EasyPieChart = new e()),
      (a.EasyPieChart.Constructor = e));
  })(window.jQuery),
  (function (e) {
    "use strict";
