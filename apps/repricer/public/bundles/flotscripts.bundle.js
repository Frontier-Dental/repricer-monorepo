    ...
    function c(c, e, f, g) {
      ...
      function m(a) {
        ...
        for (b = 0; b < ga.length; ++b)
          (c = ga[b]) && c.used && (d["x" + c.n] = c.c2p(a.left));
        for (b = 0; b < ha.length; ++b)
          (c = ha[b]) && c.used && (d["y" + c.n] = c.c2p(a.top));
        return (
          void 0 !== d.x1 && (d.x = d.x1),
      ...
      function p() {
        ...
        for (b = 0; b < _.length; ++b) {
          if (
            ((l = _[b]),
            null == l.color
              ? ((l.color = g[m].toString()), ++m)
              : "number" == typeof l.color && (l.color = g[l.color].toString()),
            null == l.lines.show)
          ) {
            var n,
              p = !0;
      ...
      function q() {
                ...
                for (f = 0; f < j; ++f)
                  ((k = n[f]),
                    ...
                    m &&
                      ...
                      null == k &&
                        (m.required && (v = !0),
                        null != m.defaultValue && (k = m.defaultValue))),
                    (i[e + f] = k));
              if (v)
                for (f = 0; f < j; ++f)
                  ((k = i[e + f]),
                    null != k &&
                      ((m = p[f]),
                      !1 !== m.autoscale &&
                        (m.x && b(g.xaxis, k, k), m.y && b(g.yaxis, k, k))),
                    (i[e + f] = null));
              else if (
                u &&
                e > 0 &&
        ...
        for (c = 0; c < _.length; ++c)
          ((g = _[c]), h(la.processDatapoints, [g, g.datapoints]));
        for (c = 0; c < _.length; ++c) {
          ((g = _[c]),
            (i = g.datapoints.points),
            (j = g.datapoints.pointsize),
      ...
      function r() {
        (oa && clearTimeout(oa),
          da.unbind("mousemove", P),
          da.unbind("mouseleave", Q),
          da.unbind("click", R),
          h(la.shutdown, [da]));
      }
      function s(a) {
        ...
        ("x" == a.direction
          ? ((c = a.scale = ja / Math.abs(e(a.max) - e(a.min))),
            (d = Math.min(e(a.max), e(a.min))))
          : ((c = a.scale = ka / Math.abs(e(a.max) - e(a.min))),
            (c = -c),
        ...
        for (
          var b = a.options,
            ...
            f =
              d ||
              ("x" == a.direction
                ? Math.floor(ba.width / (c.length || 1))
                : null),
        ...
        (a.each(f ? ga : ha, function (a, c) {
          ...
          f
            ? ((d += i),
              "bottom" == e
                ? ((ia.bottom += d + h),
                  (b.box = { top: ba.height - ia.bottom, height: d }))
                : ((b.box = { top: ia.top + h, height: d }), (ia.top += d + h)))
            : ((c += i),
              "left" == e
                ? ((b.box = { left: ia.left + h, width: c }),
                  (ia.left += c + h))
                : ((ia.right += c + h),
                  (b.box = { left: ba.width - ia.right, width: c }))),
          (b.position = e),
          (b.tickLength = g),
          (b.box.padding = i),
          (b.innermost = j));
      ...
      function v(a) {
        "x" == a.direction
          ? ((a.box.left = ia.left - a.labelWidth / 2),
            (a.box.width = ba.width - ia.left - ia.right + a.labelWidth))
          : ((a.box.top = ia.top - a.labelHeight / 2),
            (a.box.height = ba.height - ia.bottom - ia.top + a.labelHeight));
      }
      function w() {
        var b,
          c = aa.grid.minBorderMargin;
        if (null == c)
          for (c = 0, b = 0; b < _.length; ++b)
            c = Math.max(
              c,
              2 * (_[b].points.radius + _[b].points.lineWidth / 2),
            );
        ...
        (a.each(l(), function (a, b) {
          ...
          (ia.left = Math.ceil(Math.max(d.left, ia.left))),
          (ia.right = Math.ceil(Math.max(d.right, ia.right))),
          (ia.top = Math.ceil(Math.max(d.top, ia.top))),
          (ia.bottom = Math.ceil(Math.max(d.bottom, ia.bottom))));
      }
      function x() {
        var b,
          c = l(),
        ...
        for (var e in ia)
          "object" == typeof aa.grid.borderWidth
            ? (ia[e] += d ? aa.grid.borderWidth[e] : 0)
            : (ia[e] += d ? aa.grid.borderWidth : 0);
        if (
        ...
        ((ja = ba.width - ia.left - ia.right),
          (ka = ba.height - ia.bottom - ia.top),
          a.each(c, function (a, b) {
            s(b);
          }),
          d && G(),
      ...
      function z(b) {
        ...
        c =
          "number" == typeof e.ticks && e.ticks > 0
            ? e.ticks
            : 0.3 * Math.sqrt("x" == b.direction ? ba.width : ba.height);
        var f = (b.max - b.min) / c,
        ...
        if (
          ...
          if (l && l.used && l != b) {
            ...
            if (
              ...
              var n = Math.max(
                  0,
                  1 - Math.floor(Math.log(b.delta) / Math.LN10),
                ),
                o = b.tickGenerator(b);
      ...
      function E() {
        (ea.save(),
          ea.translate(ia.left, ia.top),
          (ea.fillStyle = $(
            aa.grid.backgroundColor,
            ka,
            0,
            "rgba(255, 255, 255, 0)",
          )),
          ea.fillRect(0, 0, ja, ka),
          ea.restore());
      }
      function F() {
        var b, c, d, e;
              ...
              if (!j || !k)
                if (
                  ...
                  var m = g.lineWidth || aa.grid.markingsLineWidth,
                    n = m % 2 ? 0.5 : 0;
                  (ea.beginPath(),
                    (ea.strokeStyle = g.color || aa.grid.markingsColor),
                    (ea.lineWidth = m),
                    j
                      ? (ea.moveTo(h.to + n, i.from), ea.lineTo(h.to + n, i.to))
                      : (ea.moveTo(h.from, i.to + n),
                        ea.lineTo(h.to, i.to + n)),
                    ea.stroke());
                } else
                  ((ea.fillStyle = g.color || aa.grid.markingsColor),
                    ea.fillRect(h.from, i.to, h.to - h.from, i.from - i.to));
            }
          }
          ...
          if (t.show && 0 != t.ticks.length) {
            for (
              ea.lineWidth = 1,
                ...
                t.innermost ||
                  ((ea.strokeStyle = t.options.color),
                  ea.beginPath(),
                  (r = s = 0),
                  "x" == t.direction ? (r = ja + 1) : (s = ka + 1),
                  1 == ea.lineWidth &&
                    ("x" == t.direction
                      ? (q = Math.floor(q) + 0.5)
                      : (p = Math.floor(p) + 0.5)),
                  ...
                  ea.lineTo(p + r, q + s),
                  ea.stroke()),
                ea.strokeStyle = t.options.tickColor,
                ea.beginPath(),
                b = 0;
              b < t.ticks.length;
              ++b
        ...
        (d &&
          ...
          "object" == typeof d || "object" == typeof e
            ? ("object" != typeof d &&
              ...
              d.top > 0 &&
                ((ea.strokeStyle = e.top),
                (ea.lineWidth = d.top),
                ea.beginPath(),
                ea.moveTo(0 - d.left, 0 - d.top / 2),
                ea.lineTo(ja, 0 - d.top / 2),
                ea.stroke()),
              d.right > 0 &&
                ((ea.strokeStyle = e.right),
                (ea.lineWidth = d.right),
                ea.beginPath(),
                ea.moveTo(ja + d.right / 2, 0 - d.top),
                ea.lineTo(ja + d.right / 2, ka),
                ea.stroke()),
              d.bottom > 0 &&
                ((ea.strokeStyle = e.bottom),
                (ea.lineWidth = d.bottom),
                ea.beginPath(),
                ea.moveTo(ja + d.right, ka + d.bottom / 2),
                ea.lineTo(0, ka + d.bottom / 2),
                ea.stroke()),
              d.left > 0 &&
                ((ea.strokeStyle = e.left),
                (ea.lineWidth = d.left),
                ea.beginPath(),
                ea.moveTo(0 - d.left / 2, ka + d.bottom),
                ea.lineTo(0 - d.left / 2, 0),
                ea.stroke()))
            : ((ea.lineWidth = d),
              (ea.strokeStyle = aa.grid.borderColor),
              ea.strokeRect(-d / 2, -d / 2, ja + d, ka + d))),
          ea.restore());
      }
      function G() {
        a.each(l(), function (a, b) {
                  ...
                  ("x" == b.direction
                    ...
                    : ((g = "middle"),
                      ...
                      "left" == b.position
                        ...
                        : (d = h.left + h.padding)),
                  ba.addText(j, d, e, c.label, k, null, null, f, g)));
        });
      }
      function H(a) {
        ...
        function b(a, b, c, d, e) {
          ...
          for (var j = g; j < f.length; j += g) {
            ...
            if (null != k && null != m) {
              ...
              ((k == h && l == i) || ea.moveTo(d.p2c(k) + b, e.p2c(l) + c),
                (h = m),
                (i = n),
                ea.lineTo(d.p2c(m) + b, e.p2c(n) + c));
            }
          }
          ea.stroke();
        }
          ...
          (function (a, b, c) {
            for (
              ...
              if (null != l && null != n) {
                ...
                if (
                  (h ||
                    (ea.beginPath(), ea.moveTo(b.p2c(l), c.p2c(f)), (h = !0)),
                  m >= c.max && o >= c.max)
                )
                  (ea.lineTo(b.p2c(l), c.p2c(c.max)),
                    ea.lineTo(b.p2c(n), c.p2c(c.max)));
                else if (m <= c.min && o <= c.min)
                  (ea.lineTo(b.p2c(l), c.p2c(c.min)),
                    ea.lineTo(b.p2c(n), c.p2c(c.min)));
                else {
                  var p = l,
                    q = n;
                  (m <= o && m < c.min && o >= c.min
                    ...
                    m >= o && m > c.max && o <= c.max
                      ...
                      : o >= m &&
                        ...
                        ((n = ((c.max - m) / (o - m)) * (n - l) + l),
                        (o = c.max)),
                    l != p && ea.lineTo(b.p2c(p), c.p2c(m)),
                    ea.lineTo(b.p2c(l), c.p2c(m)),
                    ea.lineTo(b.p2c(n), c.p2c(o)),
                    n != q &&
                      (ea.lineTo(b.p2c(n), c.p2c(o)),
                      ea.lineTo(b.p2c(q), c.p2c(o))));
                }
              }
            }
          })(a.datapoints, a.xaxis, a.yaxis)),
          c > 0 && b(a.datapoints, 0, 0, a.xaxis, a.yaxis),
          ea.restore());
      }
      function J(a) {
        function b(a, b, c, d, e, f, g, h) {
          for (var i = a.points, j = a.pointsize, k = 0; k < i.length; k += j) {
            ...
            null == l ||
              ...
              (m = g.p2c(m) + d),
              "circle" == h
                ? ea.arc(l, m, b, 0, e ? Math.PI : 2 * Math.PI, !1)
                : h(ea, l, m, b, e),
              ea.closePath(),
              c && ((ea.fillStyle = c), ea.fill()),
              ea.stroke());
          }
        }
        (ea.save(), ea.translate(ia.left, ia.top));
        ...
        if ((0 == c && (c = 1e-4), c > 0 && d > 0)) {
          var g = d / 2;
          ((ea.lineWidth = g),
            (ea.strokeStyle = "rgba(0,0,0,0.1)"),
            b(a.datapoints, e, null, g + g / 2, !0, a.xaxis, a.yaxis, f),
            (ea.strokeStyle = "rgba(0,0,0,0.2)"),
            b(a.datapoints, e, null, g / 2, !0, a.xaxis, a.yaxis, f));
        }
        ((ea.lineWidth = c),
          (ea.strokeStyle = a.color),
          b(a.datapoints, e, M(a.points, a.color), 0, !1, a.xaxis, a.yaxis, f),
          ea.restore());
      }
      function K(a, b, c, d, e, f, g, h, i, j, k) {
        ...
        (j
          ? ((s = q = r = !0),
            ...
            (o = b + d),
            (n = b + e),
            m < l && ((t = m), (m = l), (l = t), (p = !0), (q = !1)))
          : ((p = q = r = !0),
            (s = !1),
            (l = a + d),
            (m = a + e),
            (n = c),
            (o = b) < n && ((t = o), (o = n), (n = t), (s = !0), (r = !1))),
          m < g.min ||
            l > g.max ||
            o < h.min ||
            n > h.max ||
      ...
      function L(a) {
        ...
        })(a.datapoints, b, b + a.bars.barWidth, c, a.xaxis, a.yaxis),
          ea.restore());
      }
      function M(b, c, d, e) {
        var f = b.fill;
      ...
      function N() {
        if (
          (null != aa.legend.container
            ? a(aa.legend.container).html("")
            ...
            if (null != aa.legend.container) a(aa.legend.container).html(l);
              ...
              (null == o[0] && (o = [o, o]),
                "n" == n.charAt(0)
                  ? (m += "top:" + (o[1] + ia.top) + "px;")
                  : "s" == n.charAt(0) &&
                    (m += "bottom:" + (o[1] + ia.bottom) + "px;"),
                "e" == n.charAt(1)
                  ? (m += "right:" + (o[0] + ia.right) + "px;")
                  : "w" == n.charAt(1) &&
                    (m += "left:" + (o[0] + ia.left) + "px;"));
              var p = a(
                '<div class="legend">' +
              ...
              if (0 != aa.legend.backgroundOpacity) {
                ...
                a(
                  ...
                  .prependTo(p)
                  .css("opacity", aa.legend.backgroundOpacity);
              }
            }
          }
        }
      ...
      function S(a, b, d) {
        ...
        if (
          (i &&
            ((i.pageX = parseInt(
              i.series.xaxis.p2c(i.datapoint[0]) + e.left + ia.left,
              10,
            )),
            (i.pageY = parseInt(
              i.series.yaxis.p2c(i.datapoint[1]) + e.top + ia.top,
              10,
            ))),
          aa.grid.autoHighlight)
        ) {
      ...
      function U() {
        ...
        for (a = 0; a < na.length; ++a)
          ((b = na[a]),
            b.series.bars.show ? Z(b.series, b.point) : Y(b.series, b.point));
      ...
      function V(a, b, c) {
        ...
        var e = X(a, b);
        -1 == e
          ? (na.push({ series: a, point: b, auto: c }), T())
          : c || (na[e].auto = !1);
      }
      function W(a, b) {
        ...
        if (!(d < f.min || d > f.max || e < g.min || e > g.max)) {
          ...
          ((d = f.p2c(d)),
            ...
            "circle" == b.points.symbol
              ? fa.arc(d, e, j, 0, 2 * Math.PI, !1)
              : b.points.symbol(fa, d, e, j, !1),
            fa.closePath(),
            fa.stroke());
        }
      }
      ...
      function $(b, c, d, e) {
        ...
        for (
          var f = ea.createLinearGradient(0, d, 0, c),
            g = 0,
            h = b.colors.length;
          g < h;
          ++g
      ...
      var _ = [],
        ...
        ga = [],
        ha = [],
        ia = { left: 0, right: 0, top: 0, bottom: 0 },
        ja = 0,
        ka = 0,
        la = {
          processOptions: [],
      ...
      ((ma.setData = i),
        ...
        (ma.getAxes = function () {
          var b = {};
          return (
            a.each(ga.concat(ha), function (a, c) {
        ...
        (ma.c2p = m),
        (ma.p2c = n),
        (ma.getOptions = function () {
          return aa;
        }),
        (ma.highlight = V),
        (ma.unhighlight = W),
        (ma.triggerRedrawOverlay = T),
        (ma.pointOffset = function (a) {
          return {
        ...
        (function (b) {
          (a.extend(!0, aa, b),
            b && b.colors && (aa.colors = b.colors),
            null == aa.xaxis.color &&
              (aa.xaxis.color = a.color
                .parse(aa.grid.color)
                .scale("a", 0.22)
                .toString()),
            null == aa.yaxis.color &&
              (aa.yaxis.color = a.color
                .parse(aa.grid.color)
                .scale("a", 0.22)
                .toString()),
            null == aa.xaxis.tickColor &&
              (aa.xaxis.tickColor = aa.grid.tickColor || aa.xaxis.color),
            null == aa.yaxis.tickColor &&
              (aa.yaxis.tickColor = aa.grid.tickColor || aa.yaxis.color),
            null == aa.grid.borderColor &&
              (aa.grid.borderColor = aa.grid.color),
            null == aa.grid.tickColor &&
              (aa.grid.tickColor = a.color
                .parse(aa.grid.color)
                .scale("a", 0.22)
                .toString()));
          var d,
          ...
          for (f = aa.xaxes.length || 1, d = 0; d < f; ++d)
            ((e = aa.xaxes[d]),
              e && !e.tickColor && (e.tickColor = e.color),
              (e = a.extend(!0, {}, aa.xaxis, e)),
              (aa.xaxes[d] = e),
              e.font &&
          ...
          for (f = aa.yaxes.length || 1, d = 0; d < f; ++d)
            ((e = aa.yaxes[d]),
              e && !e.tickColor && (e.tickColor = e.color),
              (e = a.extend(!0, {}, aa.yaxis, e)),
              (aa.yaxes[d] = e),
              e.font &&
                ((e.font = a.extend({}, j, e.font)),
                e.font.color || (e.font.color = e.color),
          ...
          for (
            aa.xaxis.noTicks &&
              null == aa.xaxis.ticks &&
              (aa.xaxis.ticks = aa.xaxis.noTicks),
              aa.yaxis.noTicks &&
                null == aa.yaxis.ticks &&
                (aa.yaxis.ticks = aa.yaxis.noTicks),
              aa.x2axis &&
                ((aa.xaxes[1] = a.extend(!0, {}, aa.xaxis, aa.x2axis)),
                (aa.xaxes[1].position = "top"),
                null == aa.x2axis.min && (aa.xaxes[1].min = null),
                null == aa.x2axis.max && (aa.xaxes[1].max = null)),
              aa.y2axis &&
                ((aa.yaxes[1] = a.extend(!0, {}, aa.yaxis, aa.y2axis)),
                (aa.yaxes[1].position = "right"),
                null == aa.y2axis.min && (aa.yaxes[1].min = null),
                null == aa.y2axis.max && (aa.yaxes[1].max = null)),
              aa.grid.coloredAreas && (aa.grid.markings = aa.grid.coloredAreas),
              aa.grid.coloredAreasColor &&
                (aa.grid.markingsColor = aa.grid.coloredAreasColor),
              aa.lines && a.extend(!0, aa.series.lines, aa.lines),
              aa.points && a.extend(!0, aa.series.points, aa.points),
              aa.bars && a.extend(!0, aa.series.bars, aa.bars),
              null != aa.shadowSize && (aa.series.shadowSize = aa.shadowSize),
              null != aa.highlightColor &&
                (aa.series.highlightColor = aa.highlightColor),
              d = 0;
            d < aa.xaxes.length;
            ++d
          )
            o(ga, d + 1).options = aa.xaxes[d];
          for (d = 0; d < aa.yaxes.length; ++d)
            o(ha, d + 1).options = aa.yaxes[d];
          for (var k in la)
            aa.hooks[k] &&
              aa.hooks[k].length &&
              (la[k] = la[k].concat(aa.hooks[k]));
        ...
        (function () {
          (c
            ...
            (ba = new b("flot-base", c)),
            (ca = new b("flot-overlay", c)),
            (ea = ba.context),
            (fa = ca.context),
            (da = a(ca.element).unbind()));
          var d = c.data("plot");
        ...
        C(),
        (function () {
          (aa.grid.hoverable && (da.mousemove(P), da.bind("mouseleave", Q)),
            aa.grid.clickable && da.click(R),
            h(la.bindEvents, [da]));
        })());
      var na = [],
        oa = null;
  ...
  (function (a) {
    function b(b) {
      ...
      function f(b) {
        ...
        for (var h = 0; h < b.length; ++h) {
          var i = b[h].data[0][1];
          (e < 2 || i / c > t.series.pie.combine.threshold) &&
            g.push(
              a.extend(b[h], {
                data: [[1, i]],
                color: b[h].color,
      ...
      function g(b, e) {
        ...
        if (s) {
          ...
          ((y = e),
            (x = !1),
            (u = Math.min(g, i / t.series.pie.tilt) / 2),
            (w = i / 2 + t.series.pie.offset.top),
            (v = g / 2),
            "auto" == t.series.pie.offset.left
              ? (t.legend.position.match("w") ? (v += j / 2) : (v -= j / 2),
                v < u ? (v = u) : v > g - u && (v = g - u))
            ...
            !(function () {
              function b(a, b, c) {
                a <= 0 ||
                  ...
                  y.arc(0, 0, d, e, e + a / 2, !1),
                  y.arc(0, 0, d, e + a / 2, e + a, !1),
                  y.closePath(),
                  (e += a),
                  c ? y.fill() : y.stroke());
              }
              ...
              (y.save(),
                ...
                y.scale(1, t.series.pie.tilt),
                y.save());
              for (var e = c, f = 0; f < k.length; ++f)
                ((k[f].startAngle = e), b(k[f].angle, k[f].color, !0));
              if ((y.restore(), t.series.pie.stroke.width > 0)) {
                (y.save(), (y.lineWidth = t.series.pie.stroke.width), (e = c));
                for (var f = 0; f < k.length; ++f)
                  b(k[f].angle, t.series.pie.stroke.color, !1);
                y.restore();
              }
              return (
                h(y),
                ...
                !t.series.pie.label.show ||
                  (function () {
                    for (
                      ...
                      if (
                        k[e].percent >= 100 * t.series.pie.label.threshold &&
                        !(function (b, c, e) {
                          if (0 == b.data[0][1]) return !0;
                          var f,
                            h = t.legend.labelFormatter,
                            j = t.series.pie.label.formatter;
                          ((f = h ? h(b.label, b) : b.label),
                            j && (f = j(f, b)));
                          var k = (c + b.angle + c) / 2,
                            l = v + Math.round(Math.cos(k) * d),
                            m =
                              w +
                              Math.round(Math.sin(k) * d) * t.series.pie.tilt,
                            n =
                          ...
                          if (0 != t.series.pie.label.background.opacity) {
                            ...
                            a(
                              ...
                              .css(
                                "opacity",
                                t.series.pie.label.background.opacity,
                              )
                              .insertBefore(o);
                          }
                          return !0;
              ...
              if (
                i(
                  [
                    ...
                    [
                      h * Math.cos(k.startAngle + k.angle / 4),
                      h * Math.sin(k.startAngle + k.angle / 4),
                    ],
                    [
                      h * Math.cos(k.startAngle + k.angle / 2),
                      h * Math.sin(k.startAngle + k.angle / 2),
                    ],
                    [
                      h * Math.cos(k.startAngle + k.angle / 1.5),
                      h * Math.sin(k.startAngle + k.angle / 1.5),
                    ],
                    [
                      h * Math.cos(k.startAngle + k.angle),
                      h * Math.sin(k.startAngle + k.angle),
                    ],
                  ],
                  [d, e],
                )
      ...
      function q(a, b) {
        var c = a.getOptions(),
          d =
            c.series.pie.radius > 1
              ? c.series.pie.radius
              : u * c.series.pie.radius;
        ...
        for (var e = 0; e < z.length; ++e)
          !(function (a) {
            a.angle <= 0 ||
              isNaN(a.angle) ||
              ((b.fillStyle =
                "rgba(255, 255, 255, " + c.series.pie.highlight.opacity + ")"),
              b.beginPath(),
