  ...
  (function (t, e) {
    ...
    return (function (n) {
      ...
      function (t, l, e) {
        ...
        function s(t) {
          var e,
            n,
            i,
            r = t[0].offsetWidth - t[0].clientWidth,
          ...
          return (
            ...
            null === m &&
              ((n = v("<div><div/></div>")
                ...
                .appendTo("body")),
              (i = n.children().offset().left > n.offset().left),
              n.remove(),
              (m = i)),
            m && "rtl" === t.css("direction") ? (e.left = r) : (e.right = r),
            e
          );
        }
        function a(t) {
        ...
        ((l.compensateScroll = function (t, e) {
            ...
            (n(r),
              r.each(function (t, e) {
                var n = t === r.length - 1 ? s : o,
                  i = v(e).outerHeight(!0);
                i < n
                  ? (a.push(e), l.push(i), u.push(v(e).height()))
                  : (d += i);
              }),
              e &&
                ((t -= d),
          ...
          (l.getClientRect = function (t, e) {
            var n = t.offset(),
              i = s(t),
              r =
                n.left + u(t, "border-left-width") + i.left - (e ? e.left : 0),
          ...
          (l.getContentRect = function (t, e) {
            var n = t.offset(),
              i =
                n.left +
                u(t, "border-left-width") +
                u(t, "padding-left") -
                (e ? e.left : 0),
              r =
                n.top +
                u(t, "border-top-width") +
                u(t, "padding-top") -
                (e ? e.top : 0);
            return {
              left: i,
        ...
        ((l.isPrimaryMouseButton = function (t) {
          ...
          (l.diffByUnit = function (t, e, n) {
            return y.duration(Math.round(t.diff(e, n, !0)), n);
          }),
          (l.computeGreatestUnit = r),
          ...
          (l.divideDurationByDuration = function (t, e) {
            ...
            return o(t) || o(e)
              ...
              : ((n = t.asMonths()),
                (i = e.asMonths()),
                1 <= Math.abs(n) && g(n) && 1 <= Math.abs(i) && g(i)
                  ? n / i
                  : t.asDays() / e.asDays());
          }),
          (l.multiplyDuration = function (t, e) {
            ...
            return o(t)
              ...
              : ((n = t.asMonths()),
                1 <= Math.abs(n) && g(n)
                  ? y.duration({ months: n * e })
                  : y.duration({ days: t.asDays() * e }));
          }),
          (l.durationHasTime = o),
          ...
          o = (function (t) {
            ...
            return (
              ...
              (e.prototype.triggerWith = function (t, e, n) {
                return (
                  r(this).triggerHandler(t, { context: e, args: n }),
                  this
                );
              }),
            ...
            return (
              ...
              (t.prototype.handleInteractionStart = function (t) {
                ...
                (this.component.hitsNeeded(),
                  ...
                  t
                    ? ((i = n = { left: a.getEvX(t), top: a.getEvY(t) }),
                      r &&
                        ((e = a.getOuterRect(r)), (i = a.constrainPoint(i, e))),
                      ...
                      r &&
                        ...
                        (i = a.getRectCenter(e))),
                      (this.coordAdjust = a.diffPoints(i, n)))
              ...
              (t.prototype.handleDrag = function (t, e, n) {
                ...
                (o.prototype.handleDrag.call(this, t, e, n),
                  r((i = this.queryHit(a.getEvX(n), a.getEvY(n))), this.hit) ||
      ...
      function (t, o, e) {
        function n(t, e) {
          ...
          ((n = o.localeOptionHash[t] || (o.localeOptionHash[t] = {})),
            e && (n = o.localeOptionHash[t] = l.mergeOptions([n, e])),
            (i = r(t)),
          ...
          h = (function (i) {
            ...
            return (
              ...
              (t.prototype.queryScroll = function () {
                var t = {};
                return (
                  this.isDatesRendered && o.extend(t, this.queryDateScroll()),
                  t
                );
              }),
          ...
          i = (function () {
            ...
            return (
              ...
              (t.prototype.renderFgSegEls = function (r, t) {
                ...
                if (r.length) {
                  for (e = 0; e < r.length; e++)
                    (this.beforeFgSegHtml(r[e]),
                      (n += this.fgSegHtml(r[e], t)));
      ...
      function (t, e, n) {
        ...
        function m(t, e) {
          var n,
            i,
            r = [],
            o = l.oldMomentFormat(e, t).split(u);
          for (n = 0; n < o.length; n++)
            (i = o[n]).charAt(0) === d
              ? r.push(p[i.substring(1)](e))
              : r.push(i);
          return r;
        }
        function w(t) {
        ...
        ((l.newMomentProto.format = function () {
          return this._fullCalendar && arguments[0]
            ? r(this, arguments[0])
            : this._ambigTime
              ? l.oldMomentFormat(i(this), "YYYY-MM-DD")
              : this._ambigZone
                ? l.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss")
                : this._fullCalendar
                  ? l.oldMomentFormat(i(this))
          ...
          (l.newMomentProto.toISOString = function () {
            return this._ambigTime
              ...
              : this._ambigZone
                ? l.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss")
                : this._fullCalendar
                  ? l.oldMomentProto.toISOString.apply(i(this), arguments)
                  : l.oldMomentProto.toISOString.apply(this, arguments);
          }));
        var u = "\v",
          d = "",
          c = "",
          h = new RegExp(c + "([^" + c + "]*)" + c, "g"),
          p = {
            t: function (t) {
          ...
          (e.formatRange = function (t, e, n, i, r) {
            return (
              ...
              (function (t, e, n, i, r) {
                ...
                o((n = t.localeData().longDateFormat(n) || n)),
                t,
                e,
                i || " - ",
                r,
            ...
            return (
              ...
              (t.prototype.computeRowLevelLimit = function (t) {
                ...
                for (n = 0; n < s.length; n++)
                  if (
                    ((i = s.eq(n).removeClass("fc-limited")),
                    (r = 0),
              ...
              (t.prototype.isFootprintAllowed = function (t, e, n, i, r) {
                ...
                return !(
                  ...
                  !(function (t, e) {
                    ...
                    for (n = 0; n < t.length; n++) {
                      if (
                        !1 === (r = (i = t[n].eventInstance).def.getOverlap())
                      )
                        return !1;
          ...
          P = (function () {
            ...
            return (
              ...
              (t.prototype.initialRender = function () {
                ...
                (i.addClass("fc"),
                  ...
                  this.optionsManager.watch(
                    ...
                    ["?theme", "?themeSystem"],
                    function (t) {
                      var e = new (R.getThemeSystemClass(
                  ...
                  this.optionsManager.watch(
                    ...
                    ["?businessHours"],
                    function (t) {
                      ((o.businessHourGenerator = new S.default(
                        t.businessHours,
                        o,
                      )),
                        o.view &&
              ...
              (t.prototype.initToolbars = function () {
                ((this.header = new h.default(
                  this,
                  this.computeHeaderOptions(),
                )),
                  (this.footer = new h.default(
                    this,
                  ...
                  this.optionsManager.watch(
                    ...
                    function (t) {
                      var e,
                        ...
                        i = t.firstDay;
                      "iso" === n && (n = "ISO");
                      var r = Object.create(y.getMomentLocaleData(t.locale));
              ...
              (t.prototype.updateEvent = function (t) {
                ...
                i instanceof M.default &&
                  ((e = i.buildInstance()),
                  (n = C.default.createFromRawProps(e, t, null)),
            ...
            return (
              ...
              (t.prototype.build = function (t, e, n) {
                ...
                return (
                  ...
                  (o = /^(year|month|week|day)$/.test(r.unit)),
                  (s = this.buildRenderRange(
                    this.trimHiddenDays(r.unzonedRange),
                    r.unit,
                    o,
                  )),
                  (a = (s = this.trimHiddenDays(s)).clone()),
                  this.opt("showNonCurrentDates") ||
                    (a = a.intersect(r.unzonedRange)),
                  (u = h.duration(this.opt("minTime"))),
                  (d = h.duration(this.opt("maxTime"))),
                  (a = (a = this.adjustActiveRange(a, u, d)).intersect(i)) &&
                    (t = this.msToUtcMoment(a.constrainDate(t), c)),
                  (l = r.unzonedRange.intersectsWith(i)),
                  {
                    validUnzonedRange: i,
              ...
              (t.prototype.buildRangeFromDuration = function (t, e, n, i) {
                ...
                var o,
                  ...
                  l,
                  u,
                  d = this.opt("dateAlignment");
                return (
                  d ||
                    ((o = this.opt("dateIncrement")),
                    (d = o
                      ? (s = h.duration(o)) < n
                        ? c.computeDurationGreatestUnit(s, o)
                        : i
                      : i)),
                  n.as("days") <= 1 &&
                  ...
                  this.trimHiddenDays(u) ||
                    ((t = this._view.skipHiddenDays(t, e)), r()),
                  u
                );
              }),
      ...
      function (t, e, n) {
          ...
          l = (function (e) {
            ...
            return (
              ...
              (t.prototype.handleDragStart = function (t, e) {
                var n, i;
                this.opt("droppable") &&
                  ((n = f((e ? e.item : null) || t.target)),
                  (i = this.opt("dropAccept")),
                  (f.isFunction(i) ? i.call(n[0], n) : n.is(i)) &&
              ...
              (t.prototype.listenToExternalDrag = function (e, t, n) {
                var i,
                  ...
                  p =
                    ((r = e),
                    (u = y.dataAttrPrefix) && (u += "-"),
                    (o = r.data(u + "event") || null) &&
                      (null ==
                        (s = (o = "object" == typeof o ? f.extend({}, o) : {})
                          .start) && (s = o.time),
                      (a = o.duration),
                      (l = o.stick),
                      delete o.start,
                      ...
                      delete o.duration,
                      delete o.stick),
                    null == s && (s = r.data(u + "start")),
                    null == s && (s = r.data(u + "time")),
                    null == a && (a = r.data(u + "duration")),
                    null == l && (l = r.data(u + "stick")),
                    {
                      eventProps: o,
                ...
                (this.dragListener = new m.default(c, {
                  ...
                  hitOver: function (t) {
                    ...
                    ((!!n &&
                      !!(i = d.computeExternalDrop(n, p)) &&
                      ((e = new w.default(i.buildInstances())),
                      p.eventProps
                        ? c.isEventInstanceGroupAllowed(e)
                        : c.isExternalInstanceGroupAllowed(e))) ||
                      ((i = null), v.disableCursor()),
                      i &&
                        c.renderDrag(
              ...
              (t.prototype.computeExternalDrop = function (t, e) {
                ...
                return (
                  ...
                  s.default.parse(
                    f.extend({}, e.eventProps, { start: r, end: n }),
                    new a.default(i),
                  )
                );
              }),
        ...
        ((e.default = l), r.default.mixInto(l), (y.dataAttrPrefix = ""));
      },
      function (t, e, n) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        var r = n(2),
          ...
          i = (function (i) {
            ...
            return (
              ...
              (t.prototype.computeEventDropMutation = function (t, e, n) {
                var i = new o.default();
                return (
                  i.setDateMutation(this.computeEventDateMutation(t, e)),
                  i
                );
              }),
      ...
      function (t, e, n) {
            ...
            return (
              ...
              (t.prototype.renderSkeleton = function () {
                ...
                (this.el
                  ...
                  (e = u('<div class="fc-time-grid" />').appendTo(t)),
                  this.el.find(".fc-body > tr > td").append(t),
              ...
              (t.prototype.updateSize = function (t, e, n) {
                ...
                if (
                  (a.prototype.updateSize.call(this, t, e, n),
                  (this.axisWidth = d.matchCellWidths(
              ...
              (t.prototype.computeInitialDateScroll = function () {
                var t = l.duration(this.opt("scrollTime")),
        ...
        (((e.default = f).prototype.timeGridClass = h.default),
                ...
                for (i = 0; i < h; i++) {
                  if (
                    ...
                    for (a = 0; a < r.length; a++) {
                      for (
                        n((l = r[a]).leftCol),
                          u = v('<td class="fc-event-container"/>').append(
                            l.el,
                          ),
                          l.leftCol !== l.rightCol
                            ? u.attr("colspan", l.rightCol - l.leftCol + 1)
                            : (y[i][o] = u);
                        o <= l.rightCol;
