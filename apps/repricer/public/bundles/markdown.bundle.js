(!(function (i) {
  ...
  ((i.parse = function (e, t) {
    return new h(t).toTree(e);
  }),
    (i.toHTML = function (e, t, n) {
      var r = i.toHTMLTree(e, t, n);
      return i.renderJsonML(r);
    }),
    (i.toHTMLTree = function (e, t, n) {
      ...
      var a = (function e(t, n, r) {
        ...
        "function" == typeof r.preprocessTreeNode &&
          (a = r.preprocessTreeNode(a, n));
        var o = g(a);
        if (o) {
          for (i in ((a[1] = {}), o)) a[1][i] = o[i];
          o = a[1];
        }
        ...
        switch (a[0]) {
          ...
          case "para":
            ...
            break;
          case "markdown":
            ((a[0] = "html"), o && delete o.references);
            break;
          case "code_block":
            ((a[0] = "pre"), (i = o ? 2 : 1));
            var s = ["code"];
            (s.push.apply(s, a.splice(i, a.length - i)), (a[i] = s));
            break;
          case "inlinecode":
            a[0] = "code";
            break;
        ...
        for (; i < a.length; ++i) a[i] = e(a[i], n, r);
        return a;
      })(e, i, n);
      return (
        (function e(t) {
  ...
  var f = (h.mk_block = function (e, t, n) {
  ...
  function e(o, s) {
    var l = o + "_state",
      c = "strong" == o ? "em_state" : "strong_state";
    function u(e) {
      ((this.len_after = e), (this.name = "close_" + s));
    }
    return function (e, t) {
      if (this[l][0] == s)
        return (this[l].shift(), [e.length, new u(e.length - s.length)]);
      var n = this[c].slice(),
        r = this[l].slice();
      this[l].unshift(s);
      var i = this.processInline(e.substr(s.length)),
        a = i[i.length - 1];
      this[l].shift();
      return a instanceof u
        ? (i.pop(), [e.length - a.len_after, [o].concat(i)])
        : ((this[c] = n), (this[l] = r), [s.length, s]);
    };
  }
  ((h.prototype.split_blocks = function (e, t) {
    ...
    for (
      null != (n = /^(\s*\n)/.exec(e)) &&
      ((a += l(n[0])), (r.lastIndex = n[0].length));
      null !== (n = r.exec(e));
        ...
        atxHeader: function (e, t) {
          ...
          if (n) {
            ...
            return (
              ...
              n[0].length < e.length &&
                t.unshift(
                  f(e.substr(n[0].length), e.trailing, e.lineNumber + 2),
                ),
              [r]
            );
          }
        ...
        lists: (function () {
          ...
          function C(e, t, n, r) {
            if (t) e.push(["para"].concat(n));
              ...
              var i =
                e[e.length - 1] instanceof Array && "para" == e[e.length - 1][0]
                  ? e[e.length - 1]
                  : e;
              r && 1 < e.length && n.unshift(r);
          ...
          return function (e, t) {
            var n = e.match($);
            if (n) {
              for (var r, i, a, o = [], s = y(n), l = !1, c = [o[0].list]; ; ) {
                for (
                  var u = e.split(/(?=\n)/), h = "", f = 0;
                  f < u.length;
                  f++
                  ...
                  if (void 0 !== (n = p.match(g))[1]) {
                    (h.length &&
                      (C(r, l, this.processInline(h), d), (l = !1), (h = "")),
                      (n[1] = n[1].replace(/ {0,3}\t/g, "    ")));
                    var m = Math.floor(n[1].length / 4) + 1;
                    if (m > o.length)
                      ((s = y(n)), r.push(s), (r = s[1] = ["listitem"]));
                    else {
                      var v = !1;
                      for (i = 0; i < o.length; i++)
                        if (o[i].indent == n[1]) {
                          ((s = o[i].list),
                            o.splice(i + 1, o.length - (i + 1)),
                            (v = !0));
                          break;
                        }
                      (v ||
                        (++m <= o.length
                          ? (o.splice(m, o.length - m), (s = o[m - 1].list))
                          : ((s = y(n)), r.push(s))),
                        (r = ["listitem"]),
                        s.push(r));
                    }
                  ...
                  p.length > n[0].length && (h += d + p.substr(n[0].length));
                }
                h.length &&
                  (C(r, l, this.processInline(h), d), (l = !1), (h = ""));
                var b = N(o.length, t);
                0 < b.length &&
                  (T(o, B, this), r.push.apply(r, this.toTree(b, [])));
                var _ = (t[0] && t[0].valueOf()) || "";
                if (!_.match($) && !_.match(/^ /)) break;
                e = t.shift();
                var k = this.dialect.block.horizRule(e, t);
                if (k) {
                  c.push.apply(c, k);
                  break;
                }
            ...
            function y(e) {
              var t = x.exec(e[2]) ? ["bulletlist"] : ["numberlist"];
              return (o.push({ list: t, indent: e[1] }), t);
            }
          };
        })(),
          ...
          if (e.match(/^>/m)) {
            ...
            if (">" != e[0]) {
              for (
                ...
                (i.push(r.shift()), a++);
              var o = f(i.join("\n"), "\n", e.lineNumber);
              (n.push.apply(n, this.processBlock(o, [])),
                (e = f(r.join("\n"), e.trailing, a)));
            }
            for (; t.length && ">" == t[0][0]; ) {
              var s = t.shift();
              e = f(e + e.trailing + s, s.trailing, e.lineNumber);
            }
            var l = e.replace(/^> ?/gm, ""),
            ...
            return (
              u &&
                u.references &&
                (delete u.references, d(u) && c.splice(1, 1)),
              n.push(c),
              n
            );
          }
    ...
    (h.dialects.Gruber.inline = {
      __oneElement__: function (e, t, n) {
        ...
        return (
          ...
          (r = new RegExp("([\\s\\S]*?)(" + (t.source || t) + ")").exec(e))
            ? r[1]
              ? [r[1].length, r[1]]
      ...
      "[": function (e) {
        ...
        if (s) {
          ...
          return (
            (i = {
              href:
                (l = this.dialect.inline.__call__.call(this, l, /\\/)[0]) || "",
            }),
            void 0 !== s[3] && (i.title = s[3]),
            (r = ["link", i].concat(o)),
            [a, r]
          );
        }
          ...
          ? ((a += s[0].length),
            (r = [
              ...
              (i = {
                ...
                original: t.substr(0, a),
              }),
            ].concat(o)),
            [a, r])
          : 1 == o.length && "string" == typeof o[0]
            ? ((r = [
                "link_ref",
                (i = { ref: o[0].toLowerCase(), original: t.substr(0, a) }),
                o[0],
              ]),
              [a, r])
            : [1, "["];
    ...
    (h.dialects.Gruber.inline["**"] = e("strong", "**")),
    (h.dialects.Gruber.inline.__ = e("strong", "__")),
    (h.dialects.Gruber.inline["*"] = e("em", "*")),
    (h.dialects.Gruber.inline._ = e("em", "_")),
      ...
      for (var t in e)
        if (!t.match(/^__.*__$/)) {
          var r = t
            .replace(/([\\.*+?|()\[\]{}])/g, "\\$1")
            .replace(/\n/, "\\n");
          n.push(1 == t.length ? r : "(?:" + r + ")");
        }
      ((n = n.join("|")), (e.__patterns__ = n));
      var i = e.__call__;
      e.__call__ = function (e, t) {
        return null != t ? i.call(this, e, t) : i.call(this, e, n);
      };
    }),
    (h.DialectHelpers = {}),
    (h.DialectHelpers.inline_until_char = function (e, t) {
      for (var n = 0, r = []; ; ) {
    ...
    h.buildBlockOrder(h.dialects.Gruber.block),
    h.buildInlinePatterns(h.dialects.Gruber.inline),
    (h.dialects.Maruku = h.subclassDialect(h.dialects.Gruber)),
    (h.dialects.Maruku.processMetaHash = function (e) {
      for (
        var t = (function (e) {
            var t = e.split(""),
              n = [""],
    ...
    (h.dialects.Maruku.block.block_meta = function (e, t) {
      ...
      if (n) {
        ...
        if ("" === n[1]) {
          ...
          if (((r = g(o)), "string" == typeof o)) return;
          for (a in (r || ((r = {}), o.splice(1, 0, r)), i)) r[a] = i[a];
          return [];
        }
        var s = e.replace(/\n.*$/, ""),
          l = this.processBlock(s, []);
        for (a in ((r = g(l[0])) || ((r = {}), l[0].splice(1, 0, r)), i))
          r[a] = i[a];
        return l;
      }
    }),
    (h.dialects.Maruku.block.definition_list = function (e, t) {
      var n,
        ...
        i = ["dl"];
      if ((s = e.match(r))) {
        for (var a = [e]; t.length && r.exec(t[0]); ) a.push(t.shift());
        for (var o = 0; o < a.length; ++o) {
          var s,
            l = (s = a[o].match(r))[1].replace(/\n$/, "").split(/\n/),
            c = s[2].split(/\n:\s+/);
          for (n = 0; n < l.length; ++n) i.push(["dt", l[n]]);
          for (n = 0; n < c.length; ++n)
            i.push(
              ["dd"].concat(this.processInline(c[n].replace(/(\n)\s+/, "$1"))),
            );
        }
        return [i];
      }
    }),
    (h.dialects.Maruku.block.table = function (e, t) {
      var n,
        r,
        i = function (e, t) {
          (t = t || "\\s").match(/^[\\|\[\]{}?*.+^$]$/) && (t = "\\" + t);
    ...
    (h.dialects.Maruku.inline["{:"] = function (e, t, n) {
      ...
      var a = this.dialect.processMetaHash(i[1]),
        o = g(r);
      for (var s in (o || ((o = {}), r.splice(1, 0, o)), a)) o[s] = a[s];
      return [i[0].length, ""];
    }),
    (h.dialects.Maruku.inline.__escape__ = /^\\[\\`\*_{}\[\]()#\+.!\-|:]/),
    h.buildBlockOrder(h.dialects.Maruku.block),
    h.buildInlinePatterns(h.dialects.Maruku.inline));
  var T,
    c =
      Array.isArray ||
      function (e) {
  ...
  function g(e) {
    return c(e) && 1 < e.length && "object" == typeof e[1] && !c(e[1])
      ? e[1]
      : void 0;
  }
  function u(e) {
  ...
  function m(e) {
    ...
    for (
      ...
      r.push(m(e.shift()));
    var i = "";
    for (var a in n) i += " " + a + '="' + u(n[a]) + '"';
    return "img" == t || "br" == t || "hr" == t
      ? "<" + t + i + "/>"
      : "<" + t + i + ">" + r.join("") + "</" + t + ">";
  }
  i.renderJsonML = function (e, t) {
    (t = t || {}).root = t.root || !1;
    var n = [];
    ...
    })(
      {
        1: [
          function (e, t, n) {
            ...
            var o,
              s,
              l = e("./lib/md-converters"),
              c = e("./lib/gfm-converters"),
              u = e("./lib/html-parser"),
              h = e("collapse-whitespace"),
              r = [
                "address",
                "article",
                "aside",
            ...
            function g(e, t) {
              ...
              if ("function" == typeof t) return t.call(o, e);
              throw new TypeError(
            ...
            function m(e, t) {
              ...
              return (
                ...
                n &&
                  (3 === n.nodeType
                    ? (i = r.test(n.nodeValue))
                    : 1 !== n.nodeType || f(n) || (i = r.test(n.textContent))),
                i
              );
            }
            function v(e, t) {
            ...
            function b(e) {
              var t,
                n = p(e);
              if (d(e) || /A|TH|TD/.test(e.nodeName) || !/^\s*$/i.test(n)) {
                for (var r = 0; r < s.length; r++) {
                  ...
                  if (g(e, i.filter)) {
                    ...
                    var a = v(e, n);
                    ((a.leading || a.trailing) && (n = n.trim()),
                      (t =
                        a.leading + i.replacement.call(o, n, e) + a.trailing));
                    break;
                  }
                }
                e._replacement = t;
            ...
            (((o = function (e, t) {
              ...
              var n,
                r,
                i = ((n = e),
                (r = new u().parseFromString(n, "text/html")),
                h(r.documentElement, f),
                r).body,
                a = (function (e) {
                  for (var t, n, r, i = [e], a = []; 0 < i.length; )
                    for (
                      t = i.shift(), a.push(t), n = t.childNodes, r = 0;
                      r < n.length;
                      r++
                    )
              ...
              ((s = l.slice(0)),
                t.gfm && (s = c.concat(s)),
                t.converters && (s = t.converters.concat(s)));
              for (var o = a.length - 1; 0 <= o; o--) b(a[o]);
              return p(i)
                .replace(/^[\t\r\n]+|[\t\r\n\s]+$/g, "")
                .replace(/\n\s+\n/g, "\n\n")
                .replace(/\n{3,}/g, "\n\n");
        ...
        2: [
          function (e, t, n) {
            ...
            function s(e, t) {
              ...
              return (
                0 ===
                  Array.prototype.indexOf.call(t.parentNode.childNodes, t) &&
                  (n = "| "),
                n + e + " |"
              );
            }
            ...
            t.exports = [
              ...
              },
              {
                filter: function (e) {
                  return (
                    "checkbox" === e.type && "LI" === e.parentNode.nodeName
                  );
                },
              ...
              },
              {
                ...
                replacement: function (e, t) {
                  var n = "",
                    r = { left: ":--", right: "--:", center: ":-:" };
                  if ("THEAD" === t.parentNode.nodeName)
                    for (var i = 0; i < t.childNodes.length; i++) {
                      var a = t.childNodes[i].attributes.align,
                        o = "---";
                      (a && (o = r[a.value] || o),
                        (n += s(o, t.childNodes[i])));
                    }
                  return "\n" + e + (n ? "\n" + n : "");
                },
              },
              ...
              },
              {
                filter: function (e) {
                  return (
                    "PRE" === e.nodeName &&
                    "DIV" === e.parentNode.nodeName &&
                    r.test(e.parentNode.className)
                  );
                },
                replacement: function (e, t) {
                  return (
              ...
              {
                filter: function (e) {
                  return "DIV" === e.nodeName && r.test(e.className);
                },
                replacement: function (e) {
                  return "\n\n" + e + "\n\n";
                },
            ...
            e.exports = (function () {
              ...
              : (function () {
                  ...
                  if ("undefined" == typeof document) {
                    ...
                    e.prototype.parseFromString = (function () {
                      var t = !1;
                      try {
          ...
          function (e, t, n) {
            ...
            t.exports = [
              ...
              },
              {
                ...
                replacement: function (e, t) {
                  for (var n = t.nodeName.charAt(1), r = "", i = 0; i < n; i++)
                    r += "#";
                  return "\n\n" + r + " " + e + "\n\n";
                },
              },
              ...
              },
              {
                filter: function (e) {
                  return (
                    "PRE" === e.nodeName && "CODE" === e.firstChild.nodeName
                  );
                },
                replacement: function (e, t) {
                  return (
              ...
              },
              {
                ...
                replacement: function (e, t) {
                  ...
                  var n = t.parentNode,
                    r = Array.prototype.indexOf.call(n.children, t) + 1;
              ...
              },
              {
                ...
                replacement: function (e, t) {
                  for (var n = [], r = 0; r < t.childNodes.length; r++)
                    n.push(t.childNodes[r]._replacement);
        ...
        7: [
          function (e, t, n) {
            "use strict";
            var c = e("void-elements");
            Object.keys(c).forEach(function (e) {
              c[e.toUpperCase()] = 1;
            });
            var r = {};
            function u(e) {
              return !(!e || !r[e.nodeName]);
            }
            function h(e) {
            ...
            function f(e, t) {
              return (e && e.parentNode === t) || "PRE" === t.nodeName
            ...
            (e("block-elements").forEach(function (e) {
              ...
              (t.exports = function (e, t) {
                if (e.firstChild && "PRE" !== e.nodeName) {
                  ...
                  for (
                    var n, r = null, i = !1, a = null, o = f(a, e);
                    o !== e;

                  ) {
                    if (3 === o.nodeType) {
                      var s = o.data.replace(/[ \r\n\t]+/g, " ");
                      if (
                        ((r && !/ $/.test(r.data)) ||
                          i ||
                          " " !== s[0] ||
                      ...
                      t(o) || "BR" === o.nodeName
                        ? (r && (r.data = r.data.replace(/ $/, "")),
                          (r = null),
                          (i = !1))
                        : (n = o) && c[n.nodeName] && (i = !(r = null));
                    }
                    var l = f(a, o);
                    ((a = o), (o = l));
                  }
                  r && ((r.data = r.data.replace(/ $/, "")), r.data || h(r));
                }
              }));
          },
  ...
  (function (e) {
    ...
    var i = function (n, r) {
      (y.each(
        ...
        function (e, t) {
          void 0 !== y(n).data(t) &&
            ((r = "object" == typeof r ? r : {})[t] = y(n).data(t));
        },
      ),
    ...
    i.prototype = {
      constructor: i,
      __alterButtons: function (n, r) {
        var e = this.$handler,
          i = "all" == n,
          a = this;
        y.each(e, function (e, t) {
          !1 === (!i && t.indexOf(n) < 0) &&
            r(a.$editor.find('button[data-handler="' + t + '"]'));
        });
      },
      __buildButtons: function (e, t) {
        var n,
          r = this.$ns,
          i = this.$handler,
          a = this.$callback;
          ...
          for (o = 0; o < s.length; o++) {
            ...
            for (l = 0; l < c.length; l++) {
              var h,
                ...
                m = d.btnText ? d.btnText : "",
                v = d.btnClass ? d.btnClass : "btn",
                b = d.tabIndex ? d.tabIndex : "-1",
                _ = void 0 !== d.hotkey ? d.hotkey : "",
                k = void 0 !== jQuery.hotkeys && "" !== _ ? " (" + _ + ")" : "";
              ((h = y("<button></button>"))
                .text(" " + this.__localize(m))
                .addClass("btn-default")
                .addClass(v),
                v.match(/btn\-(primary|success|info|warning|danger|link)/) &&
                  h.removeClass("btn-default"),
                h.attr({
                  type: "button",
                ...
                !0 === d.toggle && h.attr("data-toggle", "button"),
                (f = y("<span/>")).addClass(g),
                f.prependTo(h),
                u.append(h),
                i.push(p),
      ...
      __setListener: function () {
        ...
        (this.$textarea.attr("rows", n),
          ...
          this.eventSupported("keydown") &&
            this.$textarea.on("keydown", y.proxy(this.keydown, this)),
          this.eventSupported("keypress") &&
            this.$textarea.on("keypress", y.proxy(this.keypress, this)),
      ...
      __handle: function (e) {
        var t = y(e.currentTarget),
          n = this.$handler,
          r = this.$callback,
          i = t.attr("data-handler"),
          a = r[n.indexOf(i)];
        (y(e.currentTarget).focus(),
          a(this),
          this.change(this),
          i.indexOf("cmdSave") < 0 && this.$textarea.focus(),
          e.preventDefault());
      },
      __localize: function (e) {
        var t = y.fn.markdown.messages,
          n = this.$options.language;
        return void 0 !== t && void 0 !== t[n] && void 0 !== t[n][e]
          ? t[n][e]
          : e;
      },
      ...
      setFullscreen: function (e) {
        var t = this.$editor,
          n = this.$textarea;
        (!0 === e
          ? (t.addClass("md-fullscreen-mode"),
            y("body").addClass("md-nooverflow"),
            this.$options.onFullscreen(this))
          : (t.removeClass("md-fullscreen-mode"),
            y("body").removeClass("md-nooverflow"),
      ...
      showEditor: function () {
        var n,
          ...
          e = this.$ns,
          r = this.$element,
          i = (r.css("height"), r.css("width"), this.$editable),
          a = this.$handler,
          o = this.$callback,
          s = this.$options,
          l = y("<div/>", {
        ...
        if (null === this.$editor) {
          var c = y("<div/>", { class: "md-header btn-toolbar" }),
            u = [];
          if (
            (0 < s.buttons.length && (u = u.concat(s.buttons[0])),
            0 < s.additionalButtons.length &&
              y.each(s.additionalButtons[0], function (e, n) {
                var t = y.grep(u, function (e, t) {
                  return e.name === n.name;
                });
                0 < t.length
                  ? (t[0].data = t[0].data.concat(n.data))
                  : u.push(s.additionalButtons[0][e]);
              }),
            0 < s.reorderButtonGroups.length &&
              (u = u
                .filter(function (e) {
                  return -1 < s.reorderButtonGroups.indexOf(e.name);
                })
                .sort(function (e, t) {
                  return s.reorderButtonGroups.indexOf(e.name) <
                    s.reorderButtonGroups.indexOf(t.name)
                    ? -1
                    : s.reorderButtonGroups.indexOf(e.name) >
                        s.reorderButtonGroups.indexOf(t.name)
                      ? 1
                      : 0;
                })),
            0 < u.length && (c = this.__buildButtons([u], c)),
            s.fullscreen.enable &&
              c
                .append(
                  '<div class="md-controls"><a class="md-control md-control-fullscreen" href="#"><span class="' +
                    this.__getIcon(s.fullscreen.icons.fullscreenOn) +
                    '"></span></a></div>',
                )
                .on("click", ".md-control-fullscreen", function (e) {
                  (e.preventDefault(), t.setFullscreen(!0));
                }),
            l.append(c),
            r.is("textarea"))
          )
            (r.before(l), (n = r).addClass("md-input"), l.append(n));
          else {
            var h =
                "function" == typeof toMarkdown
                  ? toMarkdown(r.html())
                  : r.html(),
              f = y.trim(h);
            ((n = y("<textarea/>", { class: "md-input", val: f })),
              l.append(n),
              (i.el = r),
              (i.type = r.prop("tagName").toLowerCase()),
              (i.content = r.html()),
              y(r[0].attributes).each(function () {
                (i.attrKeys.push(this.nodeName),
                  i.attrValues.push(this.nodeValue));
              }),
              r.replaceWith(l));
          }
          var d,
            p = y("<div/>", { class: "md-footer" }),
            g = !1;
          if (s.savable) {
            g = !0;
            var m = "cmdSave";
          ...
          if (
            ((d = "function" == typeof s.footer ? s.footer(this) : s.footer),
            "" !== y.trim(d) && ((g = !0), p.append(d)),
            g && l.append(p),
            s.width &&
              "inherit" !== s.width &&
              (jQuery.isNumeric(s.width)
                ? (l.css("display", "table"), n.css("width", s.width + "px"))
                : l.addClass(s.width)),
            s.height && "inherit" !== s.height)
          )
            if (jQuery.isNumeric(s.height)) {
              var v = s.height;
              (c && (v = Math.max(0, v - c.outerHeight())),
                p && (v = Math.max(0, v - p.outerHeight())),
                n.css("height", v + "px"));
            } else l.addClass(s.height);
          ((this.$editor = l),
            (this.$textarea = n),
            (this.$editable = i),
            ...
            this.eventSupported("keydown") &&
              ...
              c.find('[data-provider="bootstrap-markdown"]').each(function () {
                var e = y(this),
                  t = e.attr("data-hotkey");
                "" !== t.toLowerCase() &&
                  n.bind("keydown", t, function () {
                    return (e.trigger("click"), !1);
                  });
              }),
            "preview" === s.initialstate
              ? this.showPreview()
              : "fullscreen" === s.initialstate &&
                s.fullscreen.enable &&
          ...
          s.fullscreen.enable &&
            ...
            (this.$editor.append(
              '<div class="md-fullscreen-controls"><a href="#" class="exit-fullscreen" title="Exit fullscreen"><span class="' +
                this.__getIcon(s.fullscreen.icons.fullscreenOff) +
                '"></span></a></div>',
            ),
            this.$editor.on("click", ".exit-fullscreen", function (e) {
              (e.preventDefault(), t.setFullscreen(!1));
            })),
          this.hideButtons(s.hiddenButtons),
          this.disableButtons(s.disabledButtons),
          s.onShow(this),
          this
        );
      },
      parseContent: function (e) {
        e = e || this.$textarea.val();
        return this.$options.parser
          ? this.$options.parser(e)
      ...
      showPreview: function () {
        ...
        return (
          1 == this.$isPreview ||
            ...
            (e =
              "string" == typeof (t = n.onPreview(this))
                ? t
                : this.parseContent()),
            a.html(e),
            i && "md-footer" == i.attr("class")
              ? a.insertBefore(i)
              : r.parent().append(a),
            a.css({
            ...
            this.$options.resize && a.css("resize", this.$options.resize),
            r.hide(),
            a.data("markdown", this),
            (this.$element.is(":disabled") || this.$element.is("[readonly]")) &&
              (this.$editor.addClass("md-editor-disabled"),
              this.disableButtons("all"))),
          this
      ...
      hidePreview: function () {
        return (
          (this.$isPreview = !1),
          this.$editor.find('div[data-provider="markdown-preview"]').remove(),
      ...
      findSelection: function (e) {
        var t;
        if (0 <= (t = this.getContent().indexOf(e)) && 0 < e.length) {
          var n,
            r = this.getSelection();
          return (
            this.setSelection(t, t + e.length),
            (n = this.getSelection()),
      ...
      getNextTab: function () {
        ...
        var e,
          t = this.$nextTab.shift();
        return (
          "function" == typeof t
            ? (e = t())
            : "object" == typeof t && 0 < t.length && (e = t),
          e
        );
      },
        ...
        switch (e.keyCode) {
          ...
          case 9:
            ...
            if (null !== (n = this.getNextTab())) {
              ...
              t =
                (i.start != i.end || i.end != this.getContent().length) &&
                (this.setSelection(
      ...
      focus: function (e) {
        ...
        return (
          ...
          y(document)
            ...
            .each(function () {
              var e;
              y(this).attr("id") !== n.attr("id") &&
                (null === (e = y(this).find("textarea").data("markdown")) &&
                  (e = y(this)
        ...
        if (r.hasClass("active") || 0 === this.$element.parent().length) {
          if ((r.removeClass("active"), n))
            if (null !== i.el) {
              var a = y("<" + i.type + "/>"),
                o = this.getContent(),
                s = this.parseContent(o);
              (y(i.attrKeys).each(function (e, t) {
                a.attr(i.attrKeys[e], i.attrValues[e]);
              }),
                a.html(s),
                r.replaceWith(a));
            } else r.hide();
    ...
    var e = y.fn.markdown;
    ((y.fn.markdown = function (r) {
      return this.each(function () {
        var e = y(this),
          t = e.data("markdown"),
          n = "object" == typeof r && r;
        t || e.data("markdown", (t = new i(this, n)));
      });
    }),
      (y.fn.markdown.messages = {}),
      (y.fn.markdown.defaults = {
        autofocus: !1,
        hideable: !1,
        savable: !1,
              ...
              data: [
                {
                  ...
                  callback: function (e) {
                    var t,
                      ...
                      i = e.getContent();
                    ((t =
                      0 === r.length ? e.__localize("strong text") : r.text),
                      (n =
                        "**" === i.substr(r.start - 2, 2) &&
                        "**" === i.substr(r.end, 2)
                          ? (e.setSelection(r.start - 2, r.end + 2),
                            e.replaceSelection(t),
                            r.start - 2)
                          : (e.replaceSelection("**" + t + "**"), r.start + 2)),
                ...
                },
                {
                  ...
                  callback: function (e) {
                    ...
                    ((t =
                      0 === r.length
                        ? e.__localize("emphasized text")
                        : r.text),
                      (n =
                        "_" === i.substr(r.start - 1, 1) &&
                        "_" === i.substr(r.end, 1)
                          ? (e.setSelection(r.start - 1, r.end + 1),
                            e.replaceSelection(t),
                            r.start - 1)
                          : (e.replaceSelection("_" + t + "_"), r.start + 1)),
                      e.setSelection(n, n + t.length));
                  },
                },
                {
                  ...
                  callback: function (e) {
                    ...
                    ((t =
                      0 === a.length
                        ? e.__localize("heading text")
                        : a.text + "\n"),
                      (r = 4),
                      (n =
                        "### " === o.substr(a.start - r, r) ||
                        ((r = 3), "###" === o.substr(a.start - r, r))
                          ? (e.setSelection(a.start - r, a.end),
                            e.replaceSelection(t),
                            a.start - r)
                          : 0 < a.start &&
                              (i = o.substr(a.start - 1, 1)) &&
                              "\n" != i
                            ? (e.replaceSelection("\n\n### " + t), a.start + 6)
                            : (e.replaceSelection("### " + t), a.start + 4)),
                      e.setSelection(n, n + t.length));
                  },
                },
              ],
              ...
              data: [
                {
                  ...
                  callback: function (e) {
                    ...
                    ((t =
                      0 === i.length
                        ? e.__localize("enter link description here")
                        : i.text),
                      (r = prompt(
                    ...
                    if (
                      ...
                      var o = y("<div>" + r + "</div>").text();
                      (e.replaceSelection("[" + t + "](" + o + ")"),
                        (n = i.start + 1),
                        e.setSelection(n, n + t.length));
                    }
                  },
                },
                {
                  ...
                  callback: function (e) {
                    ...
                    ((t =
                      0 === i.length
                        ? e.__localize("enter image description here")
                        : i.text),
                      (r = prompt(
                ...
                },
                {
                  ...
                  callback: function (e) {
                    var t,
                      ...
                      i = e.getContent();
                    ((t =
                      0 === r.length ? e.__localize("code text here") : r.text),
                      (n =
                        "```\n" === i.substr(r.start - 4, 4) &&
                        "\n```" === i.substr(r.end, 4)
                          ? (e.setSelection(r.start - 4, r.end + 4),
                            e.replaceSelection(t),
                            r.start - 4)
                          : "`" === i.substr(r.start - 1, 1) &&
                              "`" === i.substr(r.end, 1)
                            ? (e.setSelection(r.start - 1, r.end + 1),
                              e.replaceSelection(t),
                              r.start - 1)
      ...
      (y.fn.markdown.Constructor = i),
      (y.fn.markdown.noConflict = function () {
        return ((y.fn.markdown = e), this);
      }));
    var t = function (e) {
      var t = e;
    ...
    y(document)
      .on(
        ...
        function (e) {
          (t(y(this)), e.preventDefault());
        },
      )
      .on("click focusin", function (e) {
        var r;
        ((r = y(document.activeElement)),
          y(document)
            .find(".md-editor")
            .each(function () {
              var e = y(this),
                t = r.closest(".md-editor")[0] === this,
                n =
                  e.find("textarea").data("markdown") ||
                  e
                    .find('div[data-provider="markdown-preview"]')
                    .data("markdown");
              n && !t && n.blur();
