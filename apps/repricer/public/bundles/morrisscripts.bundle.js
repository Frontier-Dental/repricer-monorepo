          ...
          (n = function (z) {
            ...
            function n(t, e, i) {
              ...
              for (
                ...
                if ("M" == x[0]) ((r = a = x[1]), (n = h = x[2]));
                  ...
                  "C" == x[0]
                    ? ((r = (c = [r, n].concat(x.slice(1)))[6]), (n = c[7]))
                    : ((c = [r, n, r, n, a, h, a, h]), (r = a), (n = h));
                  for (var v = 0, y = e.length; v < y; v++) {
                    var m = e[v];
                    if ("M" == m[0]) ((s = l = m[1]), (o = u = m[2]));
                    else {
                      "C" == m[0]
                        ? ((s = (p = [s, o].concat(m.slice(1)))[6]), (o = p[7]))
                        : ((p = [s, o, s, o, l, u, l, u]), (s = l), (o = u));
                      var b = k(c, p, i);
                      if (i) f += b;
                      else {
            ...
            ((I.svg = !(I.vml = "VML" == I.type)),
              ...
              (I.angle = function (t, e, i, r, n, s) {
                ...
                return I.angle(t, e, n, s) - I.angle(i, r, n, s);
              }),
              (I.rad = function (t) {
                return ((t % 360) * U) / 180;
              }),
            ...
            ((Ut.data = function (t, e) {
              ...
              return (
                (i[t] = e),
                z("raphael.data.set." + this.id, this, e, t),
                this
              );
            }),
                ...
                return (
                  t < 1 / r
                    ...
                    : t < 2 / r
                      ? (e = i * (t -= 1.5 / r) * t + 0.75)
                      : t < 2.5 / r
                        ? (e = i * (t -= 2.25 / r) * t + 0.9375)
                        : (e = i * (t -= 2.625 / r) * t + 0.984375),
                  e
                );
              },
            });
            ...
            ((Ut.animateWith = function (t, e, i, r, n, s) {
              ...
              (Ut.setTime = function (t, e) {
                return (
                  t && null != e && this.status(t, L(e, t.ms) / t.ms),
                  this
                );
              }),
    ...
    function (t, e, i) {
      ...
      ((p = "hasOwnProperty"),
        ...
        ((y = function (t, e) {
          ...
          for (a.sort(x); a[o] < 0; )
            if (((i = h[a[o++]]), l.push(i.apply(e, n)), d))
              return ((d = r), l);
          for (c = 0; c < p; c++)
            if ("zIndex" in (i = s[c]))
              if (i.zIndex == a[o]) {
            ...
            if (!S || S.svg) {
                    ...
                    if (
                      ("open" == g
                        ? ((x += 2),
                          ...
                          (s = 1),
                          (o = i ? 4 : 1),
                          (a = { fill: "none", stroke: p.stroke }))
                        : ((o = s = x / 2),
                          (a = { fill: p.stroke, stroke: "none" })),
                      t._.arrows
                        ? i
              ...
              (((h.prototype = t).constructor = h),
                ...
                (t.transform = function (t) {
                  ...
                  return (
                    (e.transform = this.matrix.toTransformString()),
                    this
                  );
                }),
                (t.hide = function () {
      ...
      (_.Grid = (function (t) {
        ...
        return (
          ...
          (e.prototype.autoGridLines = function (t, e, i) {
            ...
            return (
              (a = e - t),
              (c = Math.floor(Math.log(a) / Math.log(10))),
              (l = Math.pow(10, c)),
              (n = Math.floor(t / l) * l),
              (r = Math.ceil(e / l) * l),
              (h = (r - n) / (i - 1)),
              1 === l &&
                1 < h &&
                Math.ceil(h) !== h &&
                ((h = Math.ceil(h)), (r = n + h * (i - 1))),
              n < 0 &&
                0 < r &&
                ((n = Math.floor(t / h) * h), (r = Math.ceil(e / h) * h)),
              h < 1
                ? ((o = Math.floor(Math.log(h) / Math.log(10))),
                  (s = (function () {
                    var t, e;
                    for (e = [], u = t = n; 0 < h ? t <= r : r <= t; u = t += h)
                      e.push(parseFloat(u.toFixed(1 - o)));
                    return e;
                  })()))
                : (s = (function () {
                    var t, e;
