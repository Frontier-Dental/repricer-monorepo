(!(function (e) {
          ...
          return e.length
            ? Z(e).reduce(
                function (e, t) {
                  var n = X(e);
                  return (
                    o(X(n), t) ? (n[n.length] = t) : (e[e.length] = [t]),
                    e
                  );
                },
                [[W(e)]],
  ...
  var agent = {
    ...
    dom =
      ...
      (pb = function (e) {
        return (
          !jb(e) && e && /^DIV|^P|^LI|^H[1-7]/.test(e.nodeName.toUpperCase())
        );
      }),
      (rb = lb("PRE")),
      (sb = lb("LI")),
      ...
      (Cb = lb("A")),
      (Fb = lb("BODY")),
      (Ib = agent.isMSIE && agent.browserVersion < 11 ? "&nbsp;" : "<br>"),
      (Jb = function (e) {
      ...
      (Kb = function (e) {
        ...
        return (
          0 === t ||
          (!mb(e) && 1 === t && e.innerHTML === Ib) ||
          !(!list.all(e.childNodes, mb) || "" !== e.innerHTML)
        );
      }),
      (Lb = function (e) {
      ...
      (ec = function (e, t) {
        ...
        if (0 === e.offset) {
          ...
          o = dc(e.node)
            ? ((n = e.node.childNodes[e.offset - 1]), Jb(n))
            : ((n = e.node), t ? 0 : e.offset - 1);
      ...
      (fc = function (e, t) {
        ...
        if (Jb(e.node) === e.offset) {
          ...
          o = dc(e.node)
            ? ((n = e.node.childNodes[e.offset]), 0)
            : ((n = e.node), t ? Jb(e.node) : e.offset + 1);
        return { node: n, offset: o };
      }),
      (gc = function (e, t) {
        ...
        return t.length
          ? 1 === t.length
            ...
            : t.reduce(function (e, t) {
                return (
                  e === n.node && (e = oc(n, o)),
                  oc({ node: t, offset: e ? dom.position(e) : Jb(t) }, o)
                );
              })
          : null;
      }),
        ...
        if (e && e.parentNode) {
          ...
          if (!t) {
            var o,
              i,
              r = [];
            for (o = 0, i = e.childNodes.length; o < i; o++)
      ...
      }),
      {
        ...
        splitPoint: function (e, t) {
          ...
          var s =
            n &&
            pc(n, e, { isSkipPaddingBlankHTML: t, isNotSplitEdgePoint: t });
          return (
    ...
    Context = function (o, e) {
      ...
      return (
        ...
        (this.initialize = function () {
          return (
            (this.layoutInfo = t.createLayout(o, e)),
            this._initialize(),
            o.hide(),
            this
          );
        ...
        (this.destroy = function () {
          (this._destroy(),
            o.removeData("summernote"),
            t.removeLayout(o, this.layoutInfo));
        }),
        (this.reset = function () {
          var e = i.isDisabled();
        ...
        (this.code = function (e) {
          ...
          return void 0 === e
            ...
            : (t
                ? this.layoutInfo.codable.val(e)
                : this.layoutInfo.editable.html(e),
              o.val(e),
              void this.triggerEvent("change", e));
        }),
        ...
        (this.initializeModule = function (e) {
          ...
          ((t.shouldInitialize = t.shouldInitialize || func.ok),
            t.shouldInitialize() &&
              (t.initialize && t.initialize(),
              t.events && dom.attachEvents(o, t.events)));
        }),
        (this.module = function (e, t, n) {
          return 1 === arguments.length
            ? this.modules[e]
            : ((this.modules[e] = new t(this)),
              void (n || this.initializeModule(e)));
        }),
        (this.removeModule = function (e) {
          var t = this.modules[e];
          (t.shouldInitialize() &&
            (t.events && dom.detachEvents(o, t.events),
            t.destroy && t.destroy()),
        ...
        (this.removeMemo = function (e) {
          (this.memos[e] && this.memos[e].destroy && this.memos[e].destroy(),
            delete this.memos[e]);
        }),
        (this.createInvokeHandler = function (t, n) {
          return function (e) {
            (e.preventDefault(),
              i.invoke(
                t,
                n || $(e.target).closest("[data-value]").data("value"),
              ));
          };
        }),
  ...
  $.fn.extend({
    summernote: function () {
      ...
      (((i = $.extend({}, $.summernote.options, i)).langInfo = $.extend(
        !0,
        {},
        $.summernote.lang["en-US"],
        $.summernote.lang[i.lang],
      )),
        (i.icons = $.extend(!0, {}, $.summernote.options.icons, i.icons)),
        this.each(function (e, t) {
          var n = $(t);
          if (!n.data("summernote")) {
            var o = new Context(n, i);
            (n.data("summernote", o),
              n.data("summernote").triggerEvent("init", o.layoutInfo));
          }
        }));
      var n = this.first();
      if (n.length) {
  ...
  var Renderer = function (o, i, r, a) {
      this.render = function (e) {
        var n = $(o);
        if (
          (r && r.contents && n.html(r.contents),
          r && r.className && n.addClass(r.className),
          r &&
            r.data &&
            $.each(r.data, function (e, t) {
              n.attr("data-" + e, t);
            }),
          r && r.click && n.on("click", r.click),
          i)
        ) {
    ...
    dropdown = renderer.create('<div class="dropdown-menu">', function (e, t) {
      var n = $.isArray(t.items)
        ? t.items
            .map(function (e) {
              return (
                '<li><a href="#" data-value="' +
                ("string" == typeof e ? e : e.value || "") +
                '">' +
                (t.template ? t.template(e) : e) +
                "</a></li>"
              );
            })
            .join("")
    ...
    palette = renderer.create(
      ...
      function (e, t) {
        for (var n = [], o = 0, i = t.colors.length; o < i; o++) {
          for (
            var r = t.eventName, a = t.colors[o], s = [], l = 0, d = a.length;
            l < d;
            l++
          ) {
            var c = a[l];
  ...
  var key =
    ...
    range =
      ((Mh = function (e, t) {
        ...
        if (0 !== n && dom.isText(a[n - 1])) {
          ...
          for (
            var c = d.text.replace(/[\r\n]/g, "").length;
            c > l.nodeValue.length && l.nextSibling;
      ...
      (Nh = function (e) {
        var a = function (e, t) {
            ...
            if (dom.isText(e)) {
              ...
              ((n = r || e.parentNode),
                (t += list.sum(list.tail(i), dom.nodeLength)),
                (o = !r));
            } else {
      ...
      (Oh = function (r, i, a, s) {
        ...
        var n = function () {
          ...
          var t = Nh({ node: r, offset: i });
          return (t.setEndPoint("EndToEnd", Nh({ node: a, offset: s })), t);
        };
        ((this.getPoints = function () {
          return { sc: r, so: i, ec: a, eo: s };
        }),
          ...
          (this.scrollIntoView = function (e) {
            ...
            return (
              e.scrollTop + t < this.sc.offsetTop &&
                (e.scrollTop += Math.abs(e.scrollTop + t - this.sc.offsetTop)),
              this
            );
          }),
          (this.normalize = function () {
            var e = function (e, t) {
                if (
                  (dom.isVisiblePoint(e) && !dom.isEdgePoint(e)) ||
                  (dom.isVisiblePoint(e) && dom.isRightEdgePoint(e) && !t) ||
                  (dom.isVisiblePoint(e) && dom.isLeftEdgePoint(e) && t) ||
                  (dom.isVisiblePoint(e) &&
                    dom.isBlock(e.node) &&
                    dom.isEmpty(e.node))
                )
                  return e;
                ...
                if (
                  ((dom.isLeftEdgePointOf(e, n) ||
                    dom.isVoid(dom.prevPoint(e).node)) &&
                    !t) ||
                  ((dom.isRightEdgePointOf(e, n) ||
                    dom.isVoid(dom.nextPoint(e).node)) &&
                    t)
                ) {
          ...
          (this.nodes = function (n, e) {
            ...
            return (
              dom.walkPoint(
                ...
                function (e) {
                  var t;
                  dom.isEditable(e.node) ||
                    (i
                      ? (dom.isLeftEdgePoint(e) && s.push(e.node),
                        dom.isRightEdgePoint(e) &&
                          list.contains(s, e.node) &&
                          (t = e.node))
                      : (t = o ? dom.ancestor(e.node, n) : e.node),
                    t && n(t) && a.push(t));
                },
                !0,
              ),
          ...
          (this.expand = function (e) {
            ...
            return (
              t && ((o.sc = t), (o.so = 0)),
              n && ((o.ec = n), (o.eo = dom.nodeLength(n))),
              new Oh(o.sc, o.so, o.ec, o.eo)
            );
          }),
          ...
          (this.splitText = function () {
            ...
            return (
              ...
              dom.isText(r) &&
                ...
                ((t.sc = r.splitText(i)),
                (t.so = 0),
                e && ((t.ec = t.sc), (t.eo = s - i))),
              new Oh(t.sc, t.so, t.ec, t.eo)
            );
          }),
          (this.deleteContents = function () {
            ...
            return (
              $.each(t, function (e, t) {
                var n = t.parentNode;
                (o.node !== n && 1 === dom.nodeLength(n) && i.push(n),
                  dom.remove(t, !1));
              }),
              $.each(i, function (e, t) {
                dom.remove(t, !1);
        ...
        ((this.isOnEditable = e(dom.isEditable)),
          (this.isOnList = e(dom.isList)),
          (this.isOnAnchor = e(dom.isAnchor)),
          (this.isOnCell = e(dom.isCell)),
          (this.isOnData = e(dom.isData)),
          ...
          (this.wrapBodyInlineWithPara = function () {
            if (dom.isBodyContainer(r) && dom.isEmpty(r))
              return (
                (r.innerHTML = dom.emptyPara),
                new Oh(r.firstChild, 0, r.firstChild, 0)
              );
            var e,
              t = this.normalize();
            ...
            if (dom.isInline(t.sc)) {
              ...
              ((e = list.last(n)),
                dom.isInline(e) ||
                  (e = n[n.length - 2] || t.sc.childNodes[t.so]));
            } else e = t.sc.childNodes[0 < t.so ? t.so - 1 : 0];
            var o = dom.listPrev(e, dom.isParaInline).reverse();
            if (
              (o = o.concat(dom.listNext(e.nextSibling, dom.isParaInline)))
                .length
            ) {
          ...
          (this.getWordRange = function (e) {
            ...
            return (
              e &&
                (t = dom.nextPointUntil(t, function (e) {
                  return !dom.isCharPoint(e);
                })),
          ...
          (this.bookmark = function (e) {
            return {
              s: { path: dom.makeOffsetPath(e, r), offset: i },
              e: { path: dom.makeOffsetPath(e, a), offset: s },
            };
          }),
      ...
      }),
      {
        create: function (e, t, n, o) {
          ...
          return i || 1 !== arguments.length
            ? i
            : (i = this.createFromNode(e)).collapse(
                dom.emptyPara === e.innerHTML,
              );
        },
        createFromSelection: function () {
          ...
          if (agent.isW3CRangeSupport) {
            ...
            var d = Mh(l, !0),
              c = Mh(s, !1);
            (dom.isText(d.node) &&
              dom.isLeftEdgePoint(d) &&
              dom.isTextNode(c.node) &&
              dom.isRightEdgePoint(c) &&
              c.node.nextSibling === d.node &&
              (d = c),
              (e = d.cont),
              (t = d.offset),
              (n = c.cont),
        ...
        createFromNode: function (e) {
          ...
          return (
            dom.isVoid(t) &&
              ((n = dom.listPrev(t).length - 1), (t = t.parentNode)),
            dom.isBR(o)
              ? ((i = dom.listPrev(o).length - 1), (o = o.parentNode))
              : dom.isVoid(o) &&
                ((i = dom.listPrev(o).length), (o = o.parentNode)),
            this.create(t, n, o, i)
          );
        },
    ...
    History = function (t) {
      var n = [],
        ...
        i = t[0],
        e = function (e) {
          (null !== e.contents && t.html(e.contents),
            null !== e.bookmark &&
              range.createFromBookmark(i, e.bookmark).select());
        };
    ...
    Style = function () {
      ((this.fromNode = function (e) {
        ...
        (this.stylePara = function (e, n) {
          $.each(e.nodes(dom.isPara, { includeAncestor: !0 }), function (e, t) {
            $(t).css(n);
          });
        }),
        (this.styleNodes = function (e, t) {
          ...
          var r = dom.makePredByNodeName(n),
            a = e.nodes(dom.isText, { fullyContains: !0 }).map(function (e) {
        ...
        (this.current = function (e) {
          ...
          return (
            (n.anchor = e.isOnAnchor() && dom.ancestor(e.sc, dom.isAnchor)),
            (n.ancestors = dom.listAncestor(e.sc, dom.isEditable)),
            (n.range = e),
            n
          );
        }));
      ...
      ((this.insertOrderedList = function (e) {
        ...
        (this.indent = function (e) {
          ...
          ($.each(i, function (e, t) {
            var n = list.head(t);
            dom.isLi(n)
              ? o.wrapList(t, n.parentNode.nodeName)
              : $.each(t, function (e, t) {
        ...
        (this.wrapList = function (e, t) {
          ...
          return (
            ...
            dom.appendChildNodes(a, e),
            r &&
              (dom.appendChildNodes(a, list.from(r.childNodes)), dom.remove(r)),
            e
          );
        }),
              ...
              var n = list.head(t),
                ...
                r =
                  1 < i.childNodes.length
                    ? dom.splitTree(
                        i,
                        { node: o.parentNode, offset: dom.position(o) + 1 },
                        { isSkipPaddingBlankHTML: !0 },
                      )
                    : null,
                a = dom.splitTree(
                  i,
                  { node: n.parentNode, offset: dom.position(n) },
                  { isSkipPaddingBlankHTML: !0 },
                );
              ((t = l
                ? dom.listDescendant(a, dom.isLi)
                : list.from(a.childNodes).filter(dom.isLi)),
                (l || !dom.isList(i.parentNode)) &&
                  (t = t.map(function (e) {
    ...
    Typing = function () {
      ...
      ((this.insertTab = function (e, t) {
        ...
        ((e = e.deleteContents()).insertNode(n, !0),
          (e = range.create(n, t)).select());
      }),
        (this.insertParagraph = function (e) {
          var t = range.create(e);
          t = (t = t.deleteContents()).wrapBodyInlineWithPara();
          var n,
            o = dom.ancestor(t.sc, dom.isPara);
          if (o) {
            if (dom.isEmpty(o) && dom.isLi(o))
              return void a.toggleList(o.parentNode.nodeName);
            if (
              dom.isEmpty(o) &&
              dom.isPara(o) &&
              dom.isBlockquote(o.parentNode)
            )
              (dom.insertAfter(o, o.parentNode), (n = o));
            else {
              n = dom.splitTree(o, t.getStartPoint());
              var i = dom.listDescendant(o, dom.isEmptyAnchor);
              ((i = i.concat(dom.listDescendant(n, dom.isEmptyAnchor))),
                $.each(i, function (e, t) {
                  dom.remove(t);
                }),
                (dom.isHeading(n) || dom.isPre(n)) &&
                  dom.isEmpty(n) &&
                  (n = dom.replace(n, "p")));
            }
          } else {
            ...
            ((n = $(dom.emptyPara)[0]),
              r ? t.sc.insertBefore(n, r) : t.sc.appendChild(n));
          }
    ...
    Editor = function (r) {
      ...
      ((this.initialize = function () {
        (i
          .on("keydown", function (e) {
            (e.keyCode === key.code.ENTER && r.triggerEvent("enter", e),
              r.triggerEvent("keydown", e),
              e.isDefaultPrevented() ||
                (c.shortcuts
                  ? o.handleKeyMap(e)
                  : o.preventDefaultEditableShortCuts(e)));
          })
          .on("keyup", function (e) {
        ...
        (i.on(
          ...
          c.airMode ||
            (c.width && n.outerWidth(c.width),
            c.height && i.outerHeight(c.height),
            c.maxHeight && i.css("max-height", c.maxHeight),
            c.minHeight && i.css("min-height", c.minHeight)),
          h.recordUndo());
      }),
        (this.destroy = function () {
          i.off();
        ...
        (this.handleKeyMap = function (e) {
          ...
          var i = t[n.join("+")];
          i
            ? (e.preventDefault(), r.invoke(i))
            : key.isEdit(e.keyCode) && this.afterCommand();
        }),
        (this.preventDefaultEditableShortCuts = function (e) {
          (e.ctrlKey || e.metaKey) &&
            list.contains([66, 73, 85], e.keyCode) &&
            e.preventDefault();
        }),
        ...
        (this.undo = function () {
          (r.triggerEvent("before.command", i.html()),
            h.undo(),
            r.triggerEvent("change", i.html()));
        }),
        r.memo("help.undo", a.help.undo),
        (this.redo = function () {
          (r.triggerEvent("before.command", i.html()),
            h.redo(),
            r.triggerEvent("change", i.html()));
      ...
      for (
        var m = (this.beforeCommand = function () {
        ...
        ((this[g[v]] = (function (t) {
          ...
          r.memo("help." + g[v], a.help[g[v]]));
      ((this.tab = function () {
        var e = this.createRange();
        e.isCollapsed() && e.isOnCell()
          ? d.tab(e)
          : (m(), f.insertTab(e, c.tabSize), p());
      }),
        r.memo("help.tab", a.help.tab),
        (this.untab = function () {
          var e = this.createRange();
          e.isCollapsed() && e.isOnCell() && d.tab(e, !0);
        }),
        r.memo("help.untab", a.help.untab),
        ...
        r.memo("help.insertParagraph", a.help.insertParagraph),
        (this.insertOrderedList = this.wrapCommand(function () {
          e.insertOrderedList(s);
        })),
        r.memo("help.insertOrderedList", a.help.insertOrderedList),
        (this.insertUnorderedList = this.wrapCommand(function () {
          e.insertUnorderedList(s);
        })),
        r.memo("help.insertUnorderedList", a.help.insertUnorderedList),
        (this.indent = this.wrapCommand(function () {
          e.indent(s);
        })),
        r.memo("help.indent", a.help.indent),
        (this.outdent = this.wrapCommand(function () {
          e.outdent(s);
        })),
        r.memo("help.outdent", a.help.outdent),
          ...
          return async
            ...
            .then(function (e) {
              (m(),
                "function" == typeof t
                  ? t(e)
                  : ("string" == typeof t && e.attr("data-filename", t),
                    e.css("width", Math.min(i.width(), e.width()))),
                e.show(),
                range.create(s).insertNode(e[0]),
                range.createFromNodeAfter(e[0]).select(),
                p());
            })
            .fail(function (e) {
        ...
        (this.insertImages = function (e) {
          $.each(e, function (e, t) {
            var n = t.name;
            c.maximumImageFileSize && c.maximumImageFileSize < t.size
              ? r.triggerEvent(
                  "image.upload.error",
                  a.image.maximumFileSizeError,
                )
              : async
                  .readFileAsDataURL(t)
                  .then(function (e) {
        ...
        (this.insertImagesOrCallback = function (e) {
          c.callbacks.onImageUpload
            ? r.triggerEvent("image.upload", e)
            : this.insertImages(e);
        }),
        (this.insertNode = this.wrapCommand(function (e) {
          (this.createRange().insertNode(e),
            range.createFromNodeAfter(e).select());
        })),
        ...
        (this.getSelectedText = function () {
          ...
          return (
            e.isOnAnchor() &&
              (e = range.createFromNode(dom.ancestor(e.sc, dom.isAnchor))),
            e.toString()
          );
        }),
      ...
      for (v = 1; v <= 6; v++)
        ((this["formatH" + v] = (function (e) {
          return function () {
            this.formatBlock("H" + e);
          };
        })(v)),
          r.memo("help.formatH" + v, a.help["formatH" + v]));
      ((this.fontSize = function (e) {
        ...
        if (t && t.isCollapsed()) {
          ...
          ($(n).css({ "font-size": e + "px" }),
            o &&
              !dom.nodeLength(o) &&
              ((o.innerHTML = dom.ZERO_WIDTH_NBSP_CHAR),
              range.createFromNodeAfter(o.firstChild).select(),
              i.data(KEY_BOGUS, o)));
        ...
        r.memo("help.insertHorizontalRule", a.help.insertHorizontalRule),
        (this.removeBogus = function () {
          var e = i.data(KEY_BOGUS);
          if (e) {
            var t = list.find(list.from(e.childNodes), dom.isText),
              n = t.nodeValue.indexOf(dom.ZERO_WIDTH_NBSP_CHAR);
            (-1 !== n && t.deleteData(n, 1),
              dom.isEmpty(e) && dom.remove(e),
              i.removeData(KEY_BOGUS));
          }
        }),
        (this.lineHeight = this.wrapCommand(function (e) {
          u.stylePara(this.createRange(), { lineHeight: e });
        })),
        (this.unlink = function () {
          var e = this.createRange();
          if (e.isOnAnchor()) {
            var t = dom.ancestor(e.sc, dom.isAnchor);
            ((e = range.createFromNode(t)).select(),
              m(),
        ...
        (this.createLink = this.wrapCommand(function (e) {
          ...
          ("string" == typeof n && (n = n.trim()),
            c.onCreateLink && (n = c.onCreateLink(n)));
          var a = [];
          if (r) {
            var s = (i = i.deleteContents()).insertNode(
              $("<A>" + t + "</A>")[0],
            );
            a.push(s);
          } else
          ...
          $.each(a, function (e, t) {
            ((n = /^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(n)
              ...
              : "http://" + n),
              $(t).attr("href", n),
              o ? $(t).attr("target", "_blank") : $(t).removeAttr("target"));
          });
    ...
    Clipboard = function (s) {
      ...
      ((this.events = {
        "summernote.keydown": function (e, t) {
          n.needKeydownHook() &&
            (t.ctrlKey || t.metaKey) &&
            t.keyCode === key.code.V &&
            (s.invoke("editor.saveRange"),
            n.$paste.focus(),
            setTimeout(function () {
              n.pasteByHook();
            }, 0));
        ...
        (this.initialize = function () {
          this.needKeydownHook()
            ? ((this.$paste = $('<div tabindex="-1" />')
              ...
              e.before(this.$paste),
              this.$paste.on("paste", function (e) {
        ...
        (this.pasteByHook = function () {
          ...
          if (dom.isImg(e)) {
            ...
            ((r.name = "clipboard.png"),
              s.invoke("editor.restoreRange"),
              s.invoke("editor.focus"),
              s.invoke("editor.insertImagesOrCallback", [r]));
          } else {
            var a = $("<div />").html(this.$paste.html()).html();
            (s.invoke("editor.restoreRange"),
              s.invoke("editor.focus"),
              a && s.invoke("editor.pasteHTML", a));
          }
          this.$paste.empty();
        }),
        (this.pasteByEvent = function (e) {
          ...
          if (t && t.items && t.items.length) {
            ...
            ("file" === n.kind &&
              ...
              s.invoke("editor.insertImagesOrCallback", [n.getAsFile()]),
              s.invoke("editor.afterCommand"));
          }
        }));
    },
    Dropzone = function (r) {
      ...
      ((this.initialize = function () {
        ...
        (this.attachDragAndDropEvent = function () {
          ...
          ((l.onDragenter = function (e) {
            ...
            t
              .on("dragenter", l.onDragenter)
              .on("dragleave", l.onDragleave)
              .on("drop", l.onDrop),
            d
            ...
            d
              .on("drop", function (e) {
                ...
                o && o.files && o.files.length
                  ? (e.preventDefault(),
                    n.focus(),
                    r.invoke("editor.insertImagesOrCallback", o.files))
                  : $.each(o.types, function (e, t) {
                      var n = o.getData(t);
                      -1 < t.toLowerCase().indexOf("text")
                        ? r.invoke("editor.pasteHTML", n)
                        : $(n).each(function () {
  ...
  var Codeview = function (o) {
      ...
      ((this.sync = function () {
        ...
        (this.toggle = function () {
          (this.isActivated() ? this.deactivate() : this.activate(),
            o.triggerEvent("codeview.toggled"));
        }),
        (this.activate = function () {
          if (
            (a.val(dom.html(r, s.prettifyHtml)),
            a.height(r.height()),
            o.invoke("toolbar.updateCodeview", !0),
            i.addClass("codeview"),
            a.focus(),
            agent.hasCodeMirror)
          ) {
        ...
        (this.deactivate = function () {
          ...
          (r.html(t),
            ...
            i.removeClass("codeview"),
            n && o.triggerEvent("change", r.html(), r),
            r.focus(),
            o.invoke("toolbar.updateCodeview", !1));
        }),
        (this.destroy = function () {
    ...
    Statusbar = function (e) {
      ...
      ((this.initialize = function () {
        i.airMode ||
          i.disableResizeEditor ||
          n.on("mousedown", function (e) {
            (e.preventDefault(), e.stopPropagation());
            var n = o.offset().top - t.scrollTop();
            t.on("mousemove", function (e) {
              var t = e.clientY - (n + EDITABLE_PADDING);
              ((t = 0 < i.minheight ? Math.max(t, i.minheight) : t),
                (t = 0 < i.maxHeight ? Math.min(t, i.maxHeight) : t),
                o.height(t));
    ...
    Fullscreen = function (t) {
      ...
      ((this.toggle = function () {
        var e = function (e) {
          (i.css("height", e.h),
            r.css("height", e.h),
            r.data("cmeditor") && r.data("cmeditor").setsize(null, e.h));
        };
        (n.toggleClass("fullscreen"),
          this.isFullscreen()
            ? (i.data("orgHeight", i.css("height")),
              a
                .on("resize", function () {
                  e({ h: a.height() - o.outerHeight() });
                })
                .trigger("resize"),
              s.css("overflow", "hidden"))
            : (a.off("resize"),
              e({ h: i.data("orgHeight") }),
              s.css("overflow", "visible")),
          t.invoke("toolbar.updateFullscreen", this.isFullscreen()));
      }),
      ...
      ((this.events = {
              ...
              if (dom.isControlSizing(e.target)) {
                ...
                (r
                  .on("mousemove", function (e) {
                    (s.invoke(
                      "editor.resizeTo",
                      { x: e.clientX - n.left, y: e.clientY - (n.top - o) },
                      t,
                      !e.shiftKey,
                    ),
                      i.update(t[0]));
        ...
        (this.update = function (e) {
          ...
          if ((s.invoke("imagePopover.update", e), t)) {
            ...
            var a = r.w + "x" + r.h;
            (n.find(".note-control-selection-info").text(a),
              s.invoke("editor.saveTarget", e));
          } else this.hide();
          return t;
        }),
        (this.hide = function () {
    ...
    AutoLink = function (i) {
      ...
      ((this.events = {
        ...
        (this.handleKeyup = function (e) {
          list.contains([key.code.ENTER, key.code.SPACE], e.keyCode) &&
            this.replace();
        }));
    },
    AutoSync = function (e) {
    ...
    Placeholder = function (t) {
      ...
      ((this.events = {
        ...
        (this.update = function () {
          var e =
            !t.invoke("codeview.isActivated") && t.invoke("editor.isEmpty");
    ...
    Buttons = function (u) {
      var a = this,
        ...
        l = (this.representShortcut = function (e) {
          var t = n[e];
          return c.shortcuts && t
            ? (agent.isMac && (t = t.replace("CMD", "⌘").replace("SHIFT", "⇧")),
              " (" +
                (t = t
                  .replace("BACKSLASH", "\\")
                  .replace("SLASH", "/")
      ...
      ((this.initialize = function () {
        ...
        (this.isFontInstalled = function (e) {
          return (
            a.fontInstalledMap.hasOwnProperty(e) ||
              (a.fontInstalledMap[e] =
                agent.isFontInstalled(e) ||
                list.contains(c.fontNamesIgnoreCheck, e)),
            a.fontInstalledMap[e]
          );
        }),
        (this.addToolbarButtons = function () {
            ...
            return f
              .buttonGroup([
                f.button({
                  ...
                  contents:
                    f.icon(c.icons.magic) + " " + f.icon(c.icons.caret, "span"),
          ...
          (u.memo("button.justifyLeft", func.invoke(e, "render")),
            u.memo("button.justifyCenter", func.invoke(t, "render")),
            u.memo("button.justifyRight", func.invoke(n, "render")),
            u.memo("button.justifyFull", func.invoke(o, "render")),
            u.memo("button.outdent", func.invoke(i, "render")),
            u.memo("button.indent", func.invoke(r, "render")),
            u.memo("button.paragraph", function () {
              return f
                .buttonGroup([
                  f.button({
                    className: "dropdown-toggle",
                    contents:
                      f.icon(c.icons.alignLeft) +
                      " " +
                      f.icon(c.icons.caret, "span"),
                  ...
                  f.dropdown([
                    ...
                    f.buttonGroup({ className: "note-list", children: [i, r] }),
                  ]),
                ])
                .render();
            }),
                  ...
                  ],
                  {
                    callback: function (e) {
                      e.find(".note-dimension-picker-mousecatcher")
                        ...
                        .mousedown(u.createInvokeHandler("editor.insertTable"))
                        .on("mousemove", a.tableMoveHandler);
                    },
                  },
                )
                .render();
          ...
          for (var n = 0, o = t.length; n < o; n++) {
            for (
              var i = t[n],
                r = i[0],
                a = i[1],
                s = f.buttonGroup({ className: "note-" + r }).render(),
                l = 0,
                d = a.length;
              l < d;
              l++
        ...
        (this.tableMoveHandler = function (e) {
          ...
          (r.css({ width: l + "em", height: d + "em" }),
            i.data("value", l + "x" + d),
            3 < l &&
              l < c.insertTableMaxSize.col &&
              a.css({ width: l + 1 + "em" }),
            3 < d &&
              d < c.insertTableMaxSize.row &&
              a.css({ height: d + 1 + "em" }),
            o.html(l + " x " + d));
        }));
    },
    Toolbar = function (e) {
      ...
      ((this.shouldInitialize = function () {
        ...
        (this.initialize = function () {
          ((i.toolbar = i.toolbar || []),
            i.toolbar.length
              ? e.invoke("buttons.build", o, i.toolbar)
              : o.hide(),
            i.toolbarContainer && o.appendTo(i.toolbarContainer),
            t.on(
        ...
        (this.updateCodeview = function (e) {
          (n.toggleBtnActive(o.find(".btn-codeview"), e),
    ...
    LinkDialog = function (l) {
      ...
      ((this.initialize = function () {
          ...
          return $.Deferred(function (n) {
            ...
            (c.onDialogShown(d.$dialog, function () {
              ...
              (i
                ...
                .val(s.url)
                .trigger("focus"),
                d.toggleLinkBtn(r, o, i),
                d.bindEnterKey(i, r),
                d.bindEnterKey(o, r),
                a.prop("checked", s.isNewWindow),
        ...
        (this.show = function () {
          ...
          (l.invoke("editor.saveRange"),
            this.showLinkDialog(e)
              .then(function (e) {
                (l.invoke("editor.restoreRange"),
                  l.invoke("editor.createLink", e));
              })
              .fail(function () {
                l.invoke("editor.restoreRange");
              }));
        ...
        (this.initialize = function () {
          this.$popover = t
            .popover({
              ...
              callback: function (e) {
                e.find(".popover-content").prepend(
      ...
      ((this.initialize = function () {
        ...
        if (l.maximumImageFileSize) {
          var n = Math.floor(Math.log(l.maximumImageFileSize) / Math.log(1024)),
            o =
              1 * (l.maximumImageFileSize / Math.pow(1024, n)).toFixed(2) +
              " " +
              " KMGTP"[n] +
              "B";
        ...
        (this.show = function () {
          (i.invoke("editor.saveRange"),
            this.showImageDialog()
              .then(function (e) {
                (a.hideDialog(r.$dialog),
                  i.invoke("editor.restoreRange"),
                  "string" == typeof e
                    ? i.invoke("editor.insertImage", e)
                    : i.invoke("editor.insertImagesOrCallback", e));
              })
              .fail(function () {
                i.invoke("editor.restoreRange");
              }));
        ...
        return Object.keys(o)
          .map(function (e) {
            ...
            return (
              n
                .append(
                  $("<label><kbd>" + e + "</kdb></label>").css({
                    width: 180,
                    "margin-right": 10,
                  }),
                )
                .append($("<span/>").html(i.memo("help." + t) || t)),
              n.html()
            );
          })
          .join("");
    ...
    AirPopover = function (o) {
      ...
      ((this.events = {
        ...
        "summernote.focusout": function (e, t) {
          agent.isFF ||
            (t.relatedTarget &&
              dom.ancestor(t.relatedTarget, func.eq(n.$popover[0]))) ||
            n.hide();
        },
      }),
        (this.shouldInitialize = function () {
      ...
      ((this.events = {
        ...
        (this.initialize = function () {
          ((this.lastWordRange = null),
            ...
            this.$content.on("click", ".note-hint-item", function () {
              (r.$content.find(".active").removeClass("active"),
        ...
        (this.replace = function () {
          ...
          if (e.length) {
            ...
            (this.lastWordRange.insertNode(t),
              range.createFromNode(t).collapse().select(),
              (this.lastWordRange = null),
              this.hide(),
              i.invoke("editor.focus"));
          }
        ...
        (this.createItemTemplates = function (o, e) {
          ...
          return e.map(function (e, t) {
            ...
            return (
              n.append(i.template ? i.template(e) : e + ""),
              n.data({ index: o, item: e }),
              0 === o && 0 === t && n.addClass("active"),
              n
            );
          });
        }),
        ...
        (this.createGroup = function (t, e) {
          ...
          return (
            this.searchKeyword(t, e, function (e) {
              (e = e || []).length &&
                (n.html(r.createItemTemplates(t, e)), r.show());
            }),
            n
          );
        }),
        (this.handleKeyup = function (e) {
          if (
            ...
            if (e.keyCode === key.code.ENTER && this.$popover.is(":visible"))
              return;
          } else {
            var t = i.invoke("editor.createRange").getWordRange(),
              n = t.toString();
