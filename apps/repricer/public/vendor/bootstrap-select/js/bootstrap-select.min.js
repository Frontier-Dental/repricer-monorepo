...
!(function (e, t) {
  ...
  !(function (z) {
    ...
    var x,
      ...
      W = { success: !1, major: "3" };
    try {
      ((W.full = (z.fn.dropdown.Constructor.VERSION || "")
        .split(" ")[0]
        .split(".")),
        (W.major = W.full[0]),
        (W.success = !0));
    ...
    var _ = new RegExp(N + "|" + R),
      ...
      K = function (e, t, i) {
        ...
        return (
          ...
          void 0 !== t && "" !== t && (n.className = t),
          "4" === W.major && n.classList.add("dropdown-item"),
      ...
      Y = function (e, t) {
        ...
        if (e.optionContent) s.innerHTML = e.optionContent;
          ...
          if (((s.textContent = e.text), e.optionIcon)) {
            ...
            (((n = (!0 === t ? F.i : F.span).cloneNode(!1)).className =
              e.iconBase + " " + e.optionIcon),
              F.fragment.appendChild(n),
              F.fragment.appendChild(o));
          }
          e.optionSubtext &&
            (((i = F.subtext.cloneNode(!1)).textContent = e.optionSubtext),
            s.appendChild(i));
        }
        if (!0 === t)
          for (; 0 < s.childNodes.length; )
            F.fragment.appendChild(s.childNodes[0]);
      ...
      Z = function (e) {
        ...
        return (
          e.labelSubtext &&
            (((t = F.subtext.cloneNode(!1)).textContent = e.labelSubtext),
            n.appendChild(t)),
          F.fragment.appendChild(n),
          F.fragment
        );
      ...
      var t = this.each(function () {
        ...
        if (e.is("select")) {
          ...
          if (t) {
            ...
            var s = e.data();
            for (var o in s)
              s.hasOwnProperty(o) && -1 !== z.inArray(o, d) && delete s[o];
            var r = z.extend(
              {},
              J.DEFAULTS,
    ...
    ((J.VERSION = "1.13.7"),
      ...
      "4" === W.major &&
        ((J.DEFAULTS.style = "btn-light"),
        (J.DEFAULTS.iconBase = ""),
        (J.DEFAULTS.tickIcon = "bs-ok-default")),
      (J.prototype = {
        constructor: J,
        init: function () {
          var i = this,
        ...
        createView: function (T, e) {
          ...
          function i(e, t) {
            ...
            if (
              ...
              (A.options.sanitize &&
                y.length &&
                P(y, A.options.whiteList, A.options.sanitizeFn),
                !0 === m &&
                  ((b =
            ...
            if (((A.prevActiveIndex = A.activeIndex), A.options.liveSearch)) {
              if (T && t) {
                ...
                (A.selectpicker.view.canHighlight[L] ||
                  ...
                  (A.activeIndex =
                    A.selectpicker.current.map.originalIndex[L]));
              }
          ...
          (this.setPositionData(),
            ...
            z(window)
              .off("resize" + M + "." + this.selectId + ".createView")
              .on(
                "resize" + M + "." + this.selectId + ".createView",
                function () {
          ...
          for (
            ...
            if ((d++, !f.classList.contains("bs-title-option"))) {
              var m,
                ...
                A = { hidden: "true" === S.getAttribute("data-hidden") };
              if (
                !0 === w.hidden ||
                f.hidden ||
                (O && (!0 === A.hidden || S.hidden)) ||
                (i.options.hideDisabled && (L || z))
              )
                ((m = f.prevHiddenIndex),
                  E && (E.prevHiddenIndex = void 0 !== m ? m : p),
                  d--);
              else {
                if (
                  (E &&
                    void 0 !== E.prevHiddenIndex &&
                    (E.prevHiddenIndex = void 0),
                  O && !0 !== w.divider)
                ) {
                  var H = " " + S.className || "",
                  ...
                  if (
                    (void 0 !== (m = f.prevHiddenIndex) &&
                      (D = h[m].previousElementSibling),
                    !D)
                  ) {
                    ((a += 1),
                      (A.subtext = S.getAttribute("data-subtext")),
                      (A.icon = S.getAttribute("data-icon")));
                    var N = S.label,
                      P = U(N),
                      R = A.subtext,
                      W = A.icon;
                    (0 !== p &&
                      ...
                      o.push(G(g, "dropdown-header" + H, a)),
                      l.push({
                        content: P,
                        subtext: R,
                        type: "optgroup-label",
                  ...
                  (o.push(G(!1, j.DIVIDER)),
                    l.push({ type: "divider", originalIndex: p, data: w }));
                else {
                  if (i.options.hideDisabled)
                    if (T)
                      C.querySelectorAll("option:disabled").length ===
                        C.children.length && (T = !1);
                ...
                B.disabled = L;
                var M = 0;
                (B.content && (M += B.content.length),
                  B.subtext && (M += B.subtext.length),
                  w.icon && (M += 1),
                  r < M && ((r = M), (t = o[o.length - 1])));
              }
            }
          }
        ...
        render: function () {
          ...
          if (
            ...
            this.options.sanitize &&
              c &&
              P([a], i.options.whiteList, i.options.sanitizeFn),
            (r.innerHTML = ""),
            r.appendChild(a),
            W.major < 4 &&
        ...
        setStyle: function (e, t) {
          ...
          (this.$element.attr("class") &&
            ...
            W.major < 4 && this.$newElement[0].classList.add("bs3"),
            (i = e ? e.split(" ") : s),
            "add" == t
          ...
          ("auto" === this.options.width
            ? requestAnimationFrame(function () {
                (i.$menu.css("min-width", "0"),
                  i.$element.on("loaded" + M, function () {
        ...
        setDisabled: function (e, t, i, n) {
          ...
          (i || (i = this.selectpicker.main.map.newIndex[e]),
            n || (n = this.selectpicker.main.elements[i]),
            (s = n.firstChild),
            n.classList.toggle(j.DISABLED, t),
            s &&
              ("4" === W.major && s.classList.toggle(j.DISABLED, t),
        ...
        clickListener: function () {
          ...
          function e() {
            y.options.liveSearch
              ? y.$searchbox.trigger("focus")
              : y.$menuInner.trigger("focus");
          }
          function i() {
            y.dropdown &&
            y.dropdown._popper &&
          ...
          (t.data("spaceSelect", !1),
            ...
            this.$element.on("shown" + M, function () {
              (y.$menuInner[0].scrollTop !== y.selectpicker.view.scrollTop &&
                (y.$menuInner[0].scrollTop = y.selectpicker.view.scrollTop),
                3 < W.major ? requestAnimationFrame(i) : e());
            }),
            this.$menuInner.on("click", "li a", function (e, t) {
              var i = z(this),
                n = y.isVirtual() ? y.selectpicker.view.position0 : 0,
                s =
                  y.selectpicker.current.map.originalIndex[
                    i.parent().index() + n
                  ],
                o = S(y.$element[0]),
              ...
              if (
                (y.multiple &&
                  ...
                  e.stopPropagation(),
                e.preventDefault(),
                !y.isDisabled() && !i.parent().hasClass(j.DISABLED))
              ) {
                      ...
                      if (u && 1 == u) {
                        ...
                        (x[2] &&
                          ...
                          u &&
                            ...
                            ($.append(z("<div>" + I + "</div>")),
                            (l = !1),
                            y.$element.trigger("maxReached" + M)),
                          f &&
                            v &&
                            ($.append(z("<div>" + k + "</div>")),
                            (l = !1),
                            y.$element.trigger("maxReachedGrp" + M)),
                          setTimeout(function () {
                            y.setSelected(s, !1);
                          }, 10),
                ...
                (!y.multiple || (y.multiple && 1 === y.options.maxOptions)
                  ...
                  l &&
                    ((o != S(y.$element[0]) && y.multiple) ||
                      (r != y.$element.prop("selectedIndex") && !y.multiple)) &&
                    ((E = [s, c.prop("selected"), o]),
            ...
            this.$menu.on(
              ...
              function (e) {
                e.currentTarget == this &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  y.options.liveSearch && !z(e.target).hasClass("close")
                    ? y.$searchbox.trigger("focus")
                    : y.$button.trigger("focus"));
              },
            ),
        ...
        val: function (e) {
          return void 0 !== e
            ? (this.$element.val(e).trigger("changed" + M, E),
              this.render(),
              (E = null),
              this.$element)
            : this.$element.val();
        ...
        refresh: function () {
          ...
          ((this.options = e),
            ...
            this.setWidth(),
            this.setSize(!0),
            this.$element.trigger("refreshed" + M));
        },
        hide: function () {
