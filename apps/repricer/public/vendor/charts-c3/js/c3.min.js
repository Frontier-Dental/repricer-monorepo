                ...
                : "y" === t
                  ...
                  : "y2" === t
                    ...
                    : "subx" === t
                      ...
                      : "arc" === t &&
                        ((e = n.arcWidth / 2), (i = n.arcHeight / 2)),
        "translate(" + e + "," + i + ")"
      );
    }),
    ...
    (C.loadFromArgs = function (t) {
      ...
      t.data
        ...
        : t.url
          ...
          : t.json
            ? e.load(
                e.convertDataToTargets(e.convertJsonToData(t.json, t.keys)),
                t,
              )
            : t.rows
              ...
              : t.columns
                ? e.load(
                    e.convertDataToTargets(e.convertColumnsToData(t.columns)),
                    t,
                  )
                : e.load(null, t);
    }),
    ...
    (C.updateXDomain = function (t, e, i, n, a) {
      ...
      return (
        ...
        e &&
          (r.x.domain(
            a ||
              (!r.brush || r.brush.empty() ? r.orgXDomain : r.brush.extent()),
          ),
          o.zoom_enabled && r.zoom.scale(r.x).updateScaleExtent()),
    ...
    (C.initBrush = function () {
      ...
      ((t.brush = e.svg.brush().on("brush", function () {
        ...
        (t.brush.update = function () {
          return (
            t.context && t.context.select("." + r.brush).call(this),
            this
          );
        }),
    ...
    (C.getDefaultExtent = function () {
      var t = this,
        ...
        i = u(e.axis_x_extent)
          ...
          : e.axis_x_extent;
      return (
        t.isTimeSeries() && (i = [t.parseDate(i[0]), t.parseDate(i[1])]),
        i
      );
    }),
    (C.initText = function () {
