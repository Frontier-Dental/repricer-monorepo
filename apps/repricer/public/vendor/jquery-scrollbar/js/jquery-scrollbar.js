...
(function (root, factory) {
          ...
          scrollx.scroll
            ...
            .on("mousedown" + namespace, function (event) {
              ...
              var data = {
                ...
                scrollbarOffset:
                  scrollx.scroll.bar.offset()[d === "x" ? "left" : "top"],
                scrollbarSize:
                  scrollx.scroll.bar[
          ...
          if (options.debug) {
            window.console &&
              console.log(
                {
                  scrollHeight:
                    container.prop("scrollHeight") + ":" + scroll.scrolly.size,
                  scrollWidth:
                    container.prop("scrollWidth") + ":" + scroll.scrollx.size,
                  visibleHeight:
                    wrapper.height() + ":" + scroll.scrolly.visible,
  ...
  function getBrowserScrollSize(actualSize) {
    ...
    return {
      ...
      width: Math.ceil(
        browser.data.outer.offset().left - browser.data.inner.offset().left ||
          0,
      ),
    };
  }
