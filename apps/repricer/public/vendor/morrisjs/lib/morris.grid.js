      ...
      this.el.bind(
        ...
        (function (_this) {
          return function (evt) {
            ...
            if (_this.selectFrom) {
              left =
                _this.data[_this.hitTest(Math.min(x, _this.selectFrom))]._x;
              right =
                _this.data[_this.hitTest(Math.max(x, _this.selectFrom))]._x;
              width = right - left;
      ...
      if (
        ...
        if (
          ...
          this.grid = function () {
            ...
            results = [];
            for (
              y = j = ref1 = this.ymin, ref2 = this.ymax, ref3 = step;
              ref3 > 0 ? j <= ref2 : j >= ref2;
              y = j += ref3
            ) {
              results.push(y);
            }
    ...
    Grid.prototype.autoGridLines = function (ymin, ymax, nlines) {
      ...
      if (step < 1) {
        ...
        grid = (function () {
          ...
          results = [];
          for (
            y = j = ref = gmin, ref1 = gmax, ref2 = step;
