  ...
  Morris.Line = (function (superClass) {
    ...
    Line.prototype.generatePaths = function () {
      ...
      return (this.paths = function () {
        ...
        results = [];
        for (
          i = k = 0, ref = this.options.ykeys.length;
          0 <= ref ? k < ref : k > ref;
          i = 0 <= ref ? ++k : --k
        ) {
          smooth =
            typeof this.options.smooth === "boolean"
              ? this.options.smooth
              : ((ref1 = this.options.ykeys[i]),
                indexOf.call(this.options.smooth, ref1) >= 0);
          coords = function () {
    ...
    Line.prototype.drawSeries = function () {
      ...
      this.seriesPoints = [];
      for (
        i = k = ref = this.options.ykeys.length - 1;
        ref <= 0 ? k <= 0 : k >= 0;
        i = ref <= 0 ? ++k : --k
      ) {
        this._drawLineFor(i);
      ...
      results = [];
      for (
        i = m = ref1 = this.options.ykeys.length - 1;
        ref1 <= 0 ? m <= 0 : m >= 0;
        i = ref1 <= 0 ? ++m : --m
      ) {
    ...
    Line.prototype.hilight = function (index) {
      ...
      if (this.prevHilight !== null && this.prevHilight !== index) {
        for (
          i = k = 0, ref = this.seriesPoints.length - 1;
          0 <= ref ? k <= ref : k >= ref;
          i = 0 <= ref ? ++k : --k
        ) {
      ...
      if (index !== null && this.prevHilight !== index) {
        for (
          i = m = 0, ref1 = this.seriesPoints.length - 1;
