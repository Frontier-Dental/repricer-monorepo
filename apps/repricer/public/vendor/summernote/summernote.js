...
(function (factory) {
  ...
  var Editor = function (handler) {
    ...
    this.removeMedia = function ($editable, value, $target) {
      ...
      handler
        .bindCustomEvent($(), $editable.data("callbacks"), "media.delete")
    ...
    this.focus = function ($editable) {
      ...
      if (agent.isFF) {
        range
          .createFromNode($editable[0].firstChild || $editable[0])
          .collapse()
          .select();
      }
    };
  ...
  var Popover = function () {
    ...
    this.update = function ($popover, styleInfo, isAirMode) {
      ...
      if (styleInfo.anchor) {
        ...
        showPopover(
          $linkPopover,
          posFromPlaceholder(styleInfo.anchor, isAirMode),
        );
      } else {
        $linkPopover.hide();
      }
      ...
      if (styleInfo.image) {
        showPopover(
          $imagePopover,
          posFromPlaceholder(styleInfo.image, isAirMode),
        );
      } else {
        $imagePopover.hide();
      }
    ...
    var tplButtonInfo = {
      ...
      fontname: function (lang, options) {
        ...
        var items = options.fontNames.reduce(function (memo, v) {
          if (
            ...
            options.fontNamesIgnoreCheck.indexOf(v) === -1
          ) {
            return memo;
          }
          realFontList.push(v);
      ...
      paragraph: function (lang, options) {
        ...
        var justifyButton = tplIconButton(
          options.iconPrefix + "align-justify",
          {
