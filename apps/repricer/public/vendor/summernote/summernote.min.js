!(function (a) {
  ...
  var b,
          ...
          return d.length
            ? 1 === d.length
              ...
              : d.reduce(function (a, d) {
                  return (
                    a === b.node && (a = ha(b, c)),
                    ha({ node: d, offset: a ? j.position(a) : E(d) }, c)
                  );
                })
            : null;
        },
          ...
          ((this.isOnEditable = m(j.isEditable)),
            ...
            (this.pasteHTML = function (b) {
              var c = this,
                ...
                e = g.from(d.childNodes);
              return (
                this.wrapBodyInlineWithPara().deleteContents(),
                a
                  .map(e.reverse(), function (a) {
            ...
            (this.getWordRange = function (a) {
              ...
              if (!j.isCharPoint(b)) return this;
              var c = j.prevPointUntil(b, function (a) {
                return !j.isCharPoint(a);
              });
              return (
                a &&
                  (b = j.nextPointUntil(b, function (a) {
                    return !j.isCharPoint(a);
                  })),
      ...
      var b = [],
        ...
        f = function (b) {
          (null !== b.contents && a.html(b.contents),
            null !== b.bookmark &&
              k.createFromBookmark(d, b.bookmark).select());
        };
      ((this.undo = function () {
        c > 0 && (c--, f(b[c]));
      }),
    ...
    r = function () {
      ...
      ((this.insertTab = function (a, b, c) {
        ...
        (this.insertParagraph = function () {
          ...
          var d,
            e = j.ancestor(c.sc, j.isPara);
          if (e) {
            if (j.isEmpty(e) && j.isLi(e))
              return void b.toggleList(e.parentNode.nodeName);
            d = j.splitTree(e, c.getStartPoint());
            var f = j.listDescendant(e, j.isEmptyAnchor);
            ((f = f.concat(j.listDescendant(d, j.isEmptyAnchor))),
              a.each(f, function (a, b) {
                j.remove(b);
              }));
          } else {
    ...
    t = function (b) {
      ...
      var i = function (a) {
          var c = j.makeLayoutInfo(a).holder();
          b.bindCustomEvent(
            c,
            a.data("callbacks"),
            "before.command",
      ...
      ((this.undo = function (a) {
        (i(a), a.data("NoteHistory").undo(), l(a));
      }),
        (this.redo = function (a) {
          (i(a), a.data("NoteHistory").redo(), l(a));
        }));
      for (
        var n = (this.beforeCommand = function (a) {
            i(a);
          }),
          o = (this.afterCommand = function (a, b) {
            (a.data("NoteHistory").recordUndo(), b || l(a));
          }),
          t = [
            "bold",
            "italic",
        ...
        this[t[u]] = (function (a) {
          return function (b, c) {
            (n(b), document.execCommand(a, !1, c), o(b, !0));
          };
        })(t[u]);
      ((this.tab = function (a, b) {
        var c = k.create();
        c.isCollapsed() && c.isOnCell()
          ? d.tab(c)
          : (n(a), f.insertTab(a, c, b.tabsize), o(a));
      }),
        (this.untab = function () {
          var a = k.create();
        ...
        (this.insertParagraph = function (a) {
          (n(a), f.insertParagraph(a), o(a));
        }),
        (this.insertOrderedList = function (a) {
          (n(a), h.insertOrderedList(a), o(a));
        }),
        (this.insertUnorderedList = function (a) {
          (n(a), h.insertUnorderedList(a), o(a));
        }),
        ...
        (this.insertNode = function (a, b) {
          ...
          (c.insertNode(b), k.createFromNode(b).collapse().select(), o(a));
        }),
        (this.insertText = function (a, b) {
          n(a);
          var c = this.createRange(a),
            d = c.insertNode(j.createText(b));
          (k.create(d, j.nodeLength(d)).select(), o(a));
        }),
        (this.pasteHTML = function (a, b) {
          n(a);
          var c = this.createRange(a),
            d = c.pasteHTML(b);
          (k.createFromNode(g.last(d)).collapse().select(), o(a));
        }),
        ...
        (this.formatPara = function (a) {
          (n(a), this.formatBlock(a, "P"), o(a));
        }));
      for (var u = 1; 6 >= u; u++)
        this["formatH" + u] = (function (a) {
          return function (b) {
      ...
      ((this.fontSize = function (b, d) {
        ...
        (this.lineHeight = function (a, b) {
          (n(a), c.stylePara(k.create(), { lineHeight: b }), o(a));
        }),
        ...
        (this.createLink = function (b, d, e) {
          var f = d.url,
            ...
            j = d.range,
            l = j.toString() !== h;
          (n(b), e.onCreateLink && (f = e.onCreateLink(f)));
          var m;
          if (l) {
          ...
          var q = k.createFromNode(g.head(m)).collapse(!0),
            r = q.getStartPoint(),
            s = k.createFromNode(g.last(m)).collapse(),
            t = s.getEndPoint();
          (k.create(r.node, r.offset, t.node, t.offset).select(), o(b));
        }),
        ...
        (this.resize = function (a, b, c) {
          (n(a), c.css({ width: 100 * b + "%", height: "" }), o(a));
        }),
        ...
        (this.removeMedia = function (c, d, e) {
          (n(c),
            e.detach(),
            b
              .bindCustomEvent(a(), c.data("callbacks"), "media.delete")
              .call(e, this.$editable),
            o(c));
        }),
        (this.focus = function (a) {
          (a.focus(),
            e.isFF &&
              k
                .createFromNode(a[0].firstChild || a[0])
                .collapse()
                .select());
        }));
    },
  ...
  var B = function (a) {
      ((this.sync = function (b) {
        ...
        (this.deactivate = function (b) {
          var c = b.holder(),
            ...
            i = d.data("options");
          if (e.hasCodeMirror) {
            var k = h.data("cmEditor");
            (h.val(k.getValue()), k.toTextArea());
          }
          var l = j.value(h, i.prettifyHtml) || j.emptyPara,
            m = g.html() !== l;
          (g.html(l),
            g.height(i.height ? h.height() : "auto"),
            d.removeClass("codeview"),
            m &&
              a.bindCustomEvent(c, g.data("callbacks"), "change")(g.html(), g),
            g.focus(),
            a.invoke("toolbar.updateCodeview", f, !1));
        }));
    },
    C = function (b) {
      var c = a(document);
    ...
    D = function (a) {
      ...
      var b = function (b) {
        var c = b.originalEvent.clipboardData,
          d = j.makeLayoutInfo(b.currentTarget || b.target),
          e = d.editable();
        if (!c || !c.items || !c.items.length) {
          var f = e.data("callbacks");
          if (!f.onImageUpload) return;
          return (
            a.invoke("editor.saveNode", e),
            ...
            void setTimeout(function () {
              ...
              if (b.length && -1 !== b[0].src.indexOf("data:")) {
                for (
                  ...
                  g[h] = f.charCodeAt(h);
                var i = new Blob([g], { type: "image/png" });
                ((i.name = "clipboard.png"),
        ...
        var h = g.head(c.items),
          i = "file" === h.kind && -1 !== h.type.indexOf("image/");
        (i && a.insertImages(d, [h.getAsFile()]),
          a.invoke("editor.afterCommand", e));
      };
    },
    E = function (b) {
      var c = function (a, b) {
        ...
        d = function (a, b) {
          a.on("keypress", function (a) {
            a.keyCode === n.code.ENTER && b.trigger("click");
          });
        };
          ...
          .Deferred(function (a) {
            ...
            b.one("shown.bs.modal", function () {
              (g.val(f.text),
                ...
                f.url || ((f.url = f.text), c(i, f.text)),
                h
                  .on("input", function () {
                    (c(i, h.val()), f.text || g.val(h.val()));
                  })
                  .val(f.url)
                  .trigger("focus")
                  .trigger("select"),
                d(h, i),
                d(g, i),
                j.prop("checked", f.newWindow),
                i.one("click", function (c) {
                  (c.preventDefault(),
                    a.resolve({
                      range: f.range,
                      url: h.val(),
    ...
    H = function () {
      ...
      var c = (this.bindCustomEvent = function (a, b, c) {
        return function () {
          var d = b[f.namespaceToCamel(c, "on")];
          return (
            d && d.apply(a[0], arguments),
      ...
      this.insertImages = function (d, e) {
        var f = d.editor(),
          ...
          j = f.data("options");
        i.onImageUpload
          ? c(h, i, "image.upload")(e)
          : a.each(e, function (a, d) {
              var e = d.name;
              j.maximumImageFileSize && j.maximumImageFileSize < d.size
                ? c(
                    h,
                    i,
                    "image.upload.error",
                  )(j.langInfo.image.maximumFileSizeError)
                : m
                    .readFileAsDataURL(d)
                    .then(function (a) {
      ...
      var d = {
        ...
        p = function (c) {
          ...
          if (e.length) {
            var f,
              ...
              k = e.attr("data-value"),
              l = e.attr("data-hide"),
              m = j.makeLayoutInfo(c.target);
            if (
              -1 !==
              a.inArray(h, ["resize", "floatMe", "removeMedia", "imageShape"])
            ) {
            ...
            if (
              ...
              a.isFunction(a.summernote.pluginEvents[h]))
            )
              a.summernote.pluginEvents[h](c, b.editor, m, k);
            else if (b.editor[h]) {
              var o = m.editable();
              (o.focus(), b.editor[h](o, k, f), c.preventDefault());
            } else d[h] && (d[h].call(this, m), c.preventDefault());
            if (-1 !== a.inArray(h, ["backColor", "foreColor"])) {
              var p = m.editor().data("options", p),
                q = p.airMode ? b.popover : b.toolbar;
              q.updateRecentColor(g.head(e), h, k);
            }
            i(c);
          }
        },
        ...
        r = function (b, c) {
          ...
          var k = { c: Math.ceil(d.x / q) || 1, r: Math.ceil(d.y / q) || 1 };
      ...
      ((this.bindKeyMap = function (c, e) {
        ...
        g.on("keydown", function (h) {
          ...
          if (k)
            if (a.summernote.pluginEvents[k]) {
              ...
              a.isFunction(l) && l(h, b.editor, c);
            } else
              b.editor[k]
                ? (b.editor[k](g, f.data("options")), h.preventDefault())
                : d[k] && (d[k].call(this, c), h.preventDefault());
        ...
        (this.attach = function (a, c) {
          (c.shortcuts && this.bindKeyMap(a, c.keyMap[e.isMac ? "mac" : "pc"]),
            a.editable().on("mousedown", h),
            a.editable().on("keyup mouseup", i),
            a.editable().on("scroll", k),
            b.clipboard.attach(a, c),
            b.handle.attach(a, c),
            a.popover().on("click", p),
            a.popover().on("mousedown", l),
            b.dragAndDrop.attach(a, c),
            c.airMode ||
              (a.toolbar().on("click", p),
              a.toolbar().on("mousedown", l),
          ...
          var m = new o(a.editable());
          (a.editable().data("NoteHistory", m),
            a
              .editable()
              .data("callbacks", {
                onInit: c.onInit,
        ...
        (this.attachCustomEvent = function (b, d) {
          ...
          (h.focus(c(f, i, "focus")),
            ...
            h.keydown(function (a) {
              (a.keyCode === n.code.ENTER && c(f, i, "enter").call(this, a),
                c(f, i, "keydown").call(this, a));
            }),
            h.keyup(c(f, i, "keyup")),
            h.on("mousedown", c(f, i, "mousedown")),
            h.on("mouseup", c(f, i, "mouseup")),
            h.on("scroll", c(f, i, "scroll")),
            h.on("paste", c(f, i, "paste")));
          var k = e.isMSIE
            ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted"
            : "input";
          (h.on(k, function () {
            c(f, i, "change")(h.html(), h);
          }),
            d.airMode ||
              (b.toolbar().click(c(f, i, "toolbar.click")),
              b.popover().click(c(f, i, "popover.click"))),
            j.isTextarea(g.head(f)) &&
              f.closest("form").submit(function (a) {
                c(f, i, "submit").call(this, a, f.code());
              }),
            c(f, i, "init")(b));
          for (var l = 0, m = a.summernote.plugins.length; m > l; l++)
            a.isFunction(a.summernote.plugins[l].init) &&
              a.summernote.plugins[l].init(b);
        }),
    ...
    I = function () {
      var b = function (a, b) {
        ...
        t = {
          ...
          help: function (a, b) {
            var c =
              ...
              '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.6</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
        ...
        w = function (a) {
          return (
            e.isMac && (a = a.replace("CMD", "⌘").replace("SHIFT", "⇧")),
            a
              .replace("BACKSLASH", "\\")
              .replace("SLASH", "/")
              .replace("LEFTBRACKET", "[")
