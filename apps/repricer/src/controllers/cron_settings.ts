...
export async function getCronSettings(req: Request, res: Response) {
  ...
  for (let setting of cronSettingsResponse) {
    setting.lastUpdatedBy = await SessionHelper.GetAuditValue(setting, "U_NAME");
    setting.lastUpdatedOn = await SessionHelper.GetAuditValue(setting, "U_TIME");
    setting.UpdatedTime = moment(setting.UpdatedTime).format("DD-MM-YYYY HH:mm:ss");
    setting.ProxyProvider_1 = await MapperHelper.GetAlternateProxyProviderId(setting, 1);
    setting.ProxyProvider_2 = await MapperHelper.GetAlternateProxyProviderId(setting, 2);
    setting.ProxyProvider_3 = await MapperHelper.GetAlternateProxyProviderId(setting, 3);
    setting.ProxyProvider_4 = await MapperHelper.GetAlternateProxyProviderId(setting, 4);
    setting.ProxyProvider_5 = await MapperHelper.GetAlternateProxyProviderId(setting, 5);
    setting.ProxyProvider_6 = await MapperHelper.GetAlternateProxyProviderId(setting, 6);
    setting.ProxyProvider_1_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_1);
    setting.ProxyProvider_2_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_2);
    setting.ProxyProvider_3_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_3);
    setting.ProxyProvider_4_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_4);
    setting.ProxyProvider_5_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_5);
    setting.ProxyProvider_6_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider_6);
    setting.ProxyProvider_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, setting.ProxyProvider);
  ...
  cronSettingsResponse.custom.ProxyProvider = hiddenCronDetails?.ProxyProvider ? hiddenCronDetails.ProxyProvider : 0;
  cronSettingsResponse.custom.IpType = hiddenCronDetails?.IpType ? hiddenCronDetails.IpType : 0;
  ...
  cronSettingsResponse.custom.NoOf422Products = await mongoMiddleware.Get422ProductCountByType("422_ERROR");
  cronSettingsResponse.custom.NoOfPriceUpdateProducts = await mongoMiddleware.Get422ProductCountByType("PRICE_UPDATE");
  cronSettingsResponse.custom.EligibleProductsCount = await mongoMiddleware.GetContextErrorItemsCount(true);
  cronSettingsResponse.custom.lastUpdatedBy = await SessionHelper.GetAuditValue(hiddenCronDetails, "U_NAME");
  cronSettingsResponse.custom.lastUpdatedOn = await SessionHelper.GetAuditValue(hiddenCronDetails, "U_TIME");
  cronSettingsResponse.custom.ProxyProvider_1 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 1);
  cronSettingsResponse.custom.ProxyProvider_2 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 2);
  cronSettingsResponse.custom.ProxyProvider_3 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 3);
  cronSettingsResponse.custom.ProxyProvider_4 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 4);
  cronSettingsResponse.custom.ProxyProvider_5 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 5);
  cronSettingsResponse.custom.ProxyProvider_6 = await MapperHelper.GetAlternateProxyProviderId(hiddenCronDetails, 6);
  cronSettingsResponse.custom.ProxyProvider_1_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_1);
  cronSettingsResponse.custom.ProxyProvider_2_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_2);
  cronSettingsResponse.custom.ProxyProvider_3_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_3);
  cronSettingsResponse.custom.ProxyProvider_4_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_4);
  cronSettingsResponse.custom.ProxyProvider_5_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_5);
  cronSettingsResponse.custom.ProxyProvider_6_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, cronSettingsResponse.custom.ProxyProvider_6);
  cronSettingsResponse.custom.ProxyProvider_Name = await MapperHelper.GetAlternateProxyProviderName(configItems, hiddenCronDetails!.ProxyProvider);
...
export async function updateCronSettings(req: Request, res: Response) {
  ...
  const cronSettingsResponse = _.filter(cronSettingsResponseFull, (x) => x.IsHidden != true);
  var listOfUpdates: any[] = [];
  var listOfUpdatedCronKey: any[] = [];
  for (const $cr in payload.cron_id_hdn as any) {
    var offset = cronSettingsResponse[$cr as any].Offset ? cronSettingsResponse[$cr as any].Offset : 0;
    const ipType = payload[`ip_type_${payload.cron_id_hdn[$cr]}`] ? payload[`ip_type_${payload.cron_id_hdn[$cr]}`] : cronSettingsResponse[$cr as any].IpType;
    const ipValue = payload[`fixed_ip_${payload.cron_id_hdn[$cr]}`] ? payload[`fixed_ip_${payload.cron_id_hdn[$cr]}`] : cronSettingsResponse[$cr as any].FixedIp;
    const proxyProv = payload.proxy_provider[$cr] ? payload.proxy_provider[$cr] : cronSettingsResponse[$cr as any].ProxyProvider;
    const existingSecretKey = cronSettingsResponse[$cr as any].SecretKey;
    const alternateProxyProviderDetails = await MapperHelper.MapAlternateProxyProviderDetails($cr, payload);
    const cronSettingPayload = new cronSettings(payload.cron_id_hdn[$cr], payload.cron_name[$cr], payload.cron_time_unit[$cr], payload.cron_time[$cr], existingSecretKey as any, true as any, payload.offset[$cr], proxyProv, ipType, ipValue, alternateProxyProviderDetails);

    if (!_.isEqual(cronSettingPayload.CronName, cronSettingsResponse[$cr as any].CronName) || !_.isEqual(cronSettingPayload.CronTime, cronSettingsResponse[$cr as any].CronTime) || !_.isEqual(cronSettingPayload.CronTimeUnit, cronSettingsResponse[$cr as any].CronTimeUnit) || !_.isEqual(cronSettingPayload.Offset.toString(), offset.toString()) || !_.isEqual(cronSettingPayload.ProxyProvider, cronSettingsResponse[$cr as any].ProxyProvider) || !_.isEqual(cronSettingPayload.IpType, cronSettingsResponse[$cr as any].IpType) || !_.isEqual(cronSettingPayload.FixedIp, cronSettingsResponse[$cr as any].FixedIp) || !_.isEqual(JSON.stringify(alternateProxyProviderDetails), JSON.stringify(cronSettingsResponse[$cr as any].AlternateProxyProvider))) {
      listOfUpdates.push(cronSettingPayload);
      if (!_.isEqual(cronSettingPayload.CronTime, cronSettingsResponse[$cr as any].CronTime) || !_.isEqual(cronSettingPayload.CronTimeUnit, cronSettingsResponse[$cr as any].CronTimeUnit) || !_.isEqual(cronSettingPayload.Offset, offset)) {
        listOfUpdatedCronKey.push(cronMapping.find((c) => c.cronId == cronSettingPayload.CronId)!.cronVariable);
      }
    }
  }
  ...
  if (cron422?.ProxyProvider != payload.proxy_provider_422 || cron422?.FixedIp != payload[`fixed_ip_${cron422?.CronId}`] || cron422?.IpType != payload[`ip_type_${cron422?.CronId}`] || cron422?.CronTime != payload.cron_time_422 || cron422?.CronTimeUnit != payload.cron_time_unit_422 || cron422?.Offset.toString() != payload.offset_422.toString() || !_.isEqual(JSON.stringify(alternateProxyProviderDetailsFor422), JSON.stringify(cron422?.AlternateProxyProvider))) {
    ...
    if (cron422?.CronTime != payload.cron_time_422 || cron422?.Offset != payload.offset_422 || cron422?.CronTimeUnit != payload.cron_time_unit_422) {
  ...
  if (listOfUpdates.length > 0) {
    ...
    if (listOfUpdatedCronKey.length > 0) {
      const cronRecreateResponse = await httpMiddleware.recreateCron(listOfUpdatedCronKey);
      if (cronRecreateResponse && cronRecreateResponse.status == 200) {
        return res.json({
          status: true,
          message: "Cron settings updated successfully.",
        });
      } else if (cronRecreateResponse && (cronRecreateResponse as any).response.data) {
        await UpdateCronSettingsList(cronSettingsResponse, req);
        return res.json({
          status: false,
          message: (cronRecreateResponse as any).response.data,
        });
      } else if (cronRecreateResponse && (cronRecreateResponse as any).message) {
        await UpdateCronSettingsList(cronSettingsResponse, req);
        return res.json({
          status: false,
...
export async function toggleCronStatus(req: Request, res: Response) {
  ...
  if (CronName && CronName != null) {
    await ToggleCronStatus(cronSettingsResponse.find((x: any) => x.CronName == CronName)?.CronId, JSON.parse(payload.Action), req);
    ...
    const existingSettings = cronSettingsResponse.find((x: any) => x.CronId == payload.CronId);
    ...
    if (JSON.parse(payload.Action) != existingSettings?.CronStatus) {
      const jobName = cronMapping.find((x) => x.cronId == payload.CronId)!.cronVariable;
      if (JSON.parse(payload.Action) == true) {
...
export async function exportItems(req: Request, res: Response) {
  ...
  let productList = await mongoMiddleware.Get422ProductDetailsByType(type.trim());
  if (productList.length > 0) {
    for (let prod of productList) {
      prod.nextCronTime = prod.nextCronTime ? moment(prod.nextCronTime).format("DD-MM-YYYY HH:mm:ss") : null;
      prod.updatedOn = prod.updatedOn ? moment(prod.updatedOn).format("DD-MM-YYYY HH:mm:ss") : null;
  ...
  res.setHeader("Content-Disposition", "attachment; filename=" + "422ExportData.xlsx");
...
async function getSecretKeyDetails(idx: any, payload: any) {
  ...
  const vendorName = ["TRADENT", "FRONTIER", "MVP", "FIRSTDENT", "TOPDENT", "TRIAD", "BITESUPPLY"];
  for (const v of vendorName) {
    ...
    switch (v) {
      ...
      case "TRIAD":
        ...
        break;
      case "BITESUPPLY":
        vDetail.secretKey = payload.secret_key_biteSupply[idx];
        break;
      default:
        break;
    }
