...
export function MapV2(productDetails: any[]) {
  return productDetails.map((p) => {
    ...
    if (item.tradent) {
      item.tradent.updatedAt = item.tradent.updatedAt ? moment(item.tradent.updatedAt).format("DD-MM-YY HH:mm:ss") : item.tradent.updatedAt;
      item.tradent.lastCronTime = item.tradent.last_cron_time ? moment(item.tradent.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.tradent.last_cron_time;
      item.tradent.lastUpdateTime = item.tradent.last_update_time ? moment(item.tradent.last_update_time).format("DD-MM-YY HH:mm:ss") : item.tradent.last_update_time;
      item.tradent.lastAttemptedTime = item.tradent.last_attempted_time ? moment(item.tradent.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.tradent.last_attempted_time;
      item.tradent.marketStateUpdatedAt = item.tradent.marketStateUpdatedAt ? moment(item.tradent.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.tradent.marketStateUpdatedAt;
      item.tradent.tags = removeBackslashes(item.tradent.tags);
    }
    if (item.frontier) {
      item.frontier.updatedAt = item.frontier.updatedAt ? moment(item.frontier.updatedAt).format("DD-MM-YY HH:mm:ss") : item.frontier.updatedAt;
      item.frontier.lastCronTime = item.frontier.last_cron_time ? moment(item.frontier.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.frontier.last_cron_time;
      item.frontier.lastUpdateTime = item.frontier.last_update_time ? moment(item.frontier.last_update_time).format("DD-MM-YY HH:mm:ss") : item.frontier.last_update_time;
      item.frontier.lastAttemptedTime = item.frontier.last_attempted_time ? moment(item.frontier.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.frontier.last_attempted_time;
      item.frontier.marketStateUpdatedAt = item.frontier.marketStateUpdatedAt ? moment(item.frontier.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.frontier.marketStateUpdatedAt;
      item.frontier.tags = removeBackslashes(item.frontier.tags);
    }
    if (item.mvp) {
      item.mvp.updatedAt = item.mvp.updatedAt ? moment(item.mvp.updatedAt).format("DD-MM-YY HH:mm:ss") : item.mvp.updatedAt;
      item.mvp.lastCronTime = item.mvp.last_cron_time ? moment(item.mvp.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.mvp.last_cron_time;
      item.mvp.lastUpdateTime = item.mvp.last_update_time ? moment(item.mvp.last_update_time).format("DD-MM-YY HH:mm:ss") : item.mvp.last_update_time;
      item.mvp.lastAttemptedTime = item.mvp.last_attempted_time ? moment(item.mvp.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.mvp.last_attempted_time;
      item.mvp.marketStateUpdatedAt = item.mvp.marketStateUpdatedAt ? moment(item.mvp.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.mvp.marketStateUpdatedAt;
      item.mvp.tags = removeBackslashes(item.mvp.tags);
    }
    if (item.topDent) {
      item.topDent.updatedAt = item.topDent.updatedAt ? moment(item.topDent.updatedAt).format("DD-MM-YY HH:mm:ss") : item.topDent.updatedAt;
      item.topDent.lastCronTime = item.topDent.last_cron_time ? moment(item.topDent.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.topDent.last_cron_time;
      item.topDent.lastUpdateTime = item.topDent.last_update_time ? moment(item.topDent.last_update_time).format("DD-MM-YY HH:mm:ss") : item.topDent.last_update_time;
      item.topDent.lastAttemptedTime = item.topDent.last_attempted_time ? moment(item.topDent.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.topDent.last_attempted_time;
      item.topDent.marketStateUpdatedAt = item.topDent.marketStateUpdatedAt ? moment(item.topDent.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.topDent.marketStateUpdatedAt;
      item.topDent.tags = removeBackslashes(item.topDent.tags);
    }
    if (item.firstDent) {
      item.firstDent.updatedAt = item.firstDent.updatedAt ? moment(item.firstDent.updatedAt).format("DD-MM-YY HH:mm:ss") : item.firstDent.updatedAt;
      item.firstDent.lastCronTime = item.firstDent.last_cron_time ? moment(item.firstDent.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.firstDent.last_cron_time;
      item.firstDent.lastUpdateTime = item.firstDent.last_update_time ? moment(item.firstDent.last_update_time).format("DD-MM-YY HH:mm:ss") : item.firstDent.last_update_time;
      item.firstDent.lastAttemptedTime = item.firstDent.last_attempted_time ? moment(item.firstDent.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.firstDent.last_attempted_time;
      item.firstDent.marketStateUpdatedAt = item.firstDent.marketStateUpdatedAt ? moment(item.firstDent.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.firstDent.marketStateUpdatedAt;
      item.firstDent.tags = removeBackslashes(item.firstDent.tags);
    }
    if (item.triad) {
      item.triad.updatedAt = item.triad.updatedAt ? moment(item.triad.updatedAt).format("DD-MM-YY HH:mm:ss") : item.triad.updatedAt;
      item.triad.lastCronTime = item.triad.last_cron_time ? moment(item.triad.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.triad.last_cron_time;
      item.triad.lastUpdateTime = item.triad.last_update_time ? moment(item.triad.last_update_time).format("DD-MM-YY HH:mm:ss") : item.triad.last_update_time;
      item.triad.lastAttemptedTime = item.triad.last_attempted_time ? moment(item.triad.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.triad.last_attempted_time;
      item.triad.marketStateUpdatedAt = item.triad.marketStateUpdatedAt ? moment(item.triad.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.triad.marketStateUpdatedAt;
      item.triad.tags = removeBackslashes(item.triad.tags);
    }
    if (item.biteSupply) {
      item.biteSupply.updatedAt = item.biteSupply.updatedAt ? moment(item.biteSupply.updatedAt).format("DD-MM-YY HH:mm:ss") : item.biteSupply.updatedAt;
      item.biteSupply.lastCronTime = item.biteSupply.last_cron_time ? moment(item.biteSupply.last_cron_time).format("DD-MM-YY HH:mm:ss") : item.biteSupply.last_cron_time;
      item.biteSupply.lastUpdateTime = item.biteSupply.last_update_time ? moment(item.biteSupply.last_update_time).format("DD-MM-YY HH:mm:ss") : item.biteSupply.last_update_time;
      item.biteSupply.lastAttemptedTime = item.biteSupply.last_attempted_time ? moment(item.biteSupply.last_attempted_time).format("DD-MM-YY HH:mm:ss") : item.biteSupply.last_attempted_time;
      item.biteSupply.marketStateUpdatedAt = item.biteSupply.marketStateUpdatedAt ? moment(item.biteSupply.marketStateUpdatedAt).format("DD-MM-YY HH:mm:ss") : item.biteSupply.marketStateUpdatedAt;
...
export function MapBadgeIndicator(product: any) {
  if (product.tradentDetails) {
    product.tradentDetails.badge_indicator = parseBadgeIndicator(product.tradentDetails.badgeIndicator, "KEY");
  }
  if (product.frontierDetails) {
    product.frontierDetails.badge_indicator = parseBadgeIndicator(product.frontierDetails.badgeIndicator, "KEY");
  }
  if (product.mvpDetails) {
    product.mvpDetails.badge_indicator = parseBadgeIndicator(product.mvpDetails.badgeIndicator, "KEY");
  }
  if (product.firstDentDetails) {
    product.firstDentDetails.badge_indicator = parseBadgeIndicator(product.firstDentDetails.badgeIndicator, "KEY");
  }
  if (product.topDentDetails) {
    product.topDentDetails.badge_indicator = parseBadgeIndicator(product.topDentDetails.badgeIndicator, "KEY");
  }

  if (product.triadDetails) {
    product.triadDetails.badge_indicator = parseBadgeIndicator(product.triadDetails.badgeIndicator, "KEY");
  }
  if (product.biteSupplyDetails) {
    product.biteSupplyDetails.badge_indicator = parseBadgeIndicator(product.biteSupplyDetails.badgeIndicator, "KEY");
  }
  return product;
}
...
export const MapCronName = async (prod: any, cronSettings: any) => {
  if (prod.tradentDetails && prod.tradentDetails.cronId) {
    prod.tradentDetails.cronName = cronSettings.find((x: any) => x.CronId == prod.tradentDetails.cronId) ? cronSettings.find((x: any) => x.CronId == prod.tradentDetails.cronId).CronName : "N/A";
  }
  if (prod.frontierDetails && prod.frontierDetails.cronId) {
    prod.frontierDetails.cronName = cronSettings.find((x: any) => x.CronId == prod.frontierDetails.cronId) ? cronSettings.find((x: any) => x.CronId == prod.frontierDetails.cronId).CronName : "N/A";
  }
  if (prod.mvpDetails && prod.mvpDetails.cronId) {
    prod.mvpDetails.cronName = cronSettings.find((x: any) => x.CronId == prod.mvpDetails.cronId) ? cronSettings.find((x: any) => x.CronId == prod.mvpDetails.cronId).CronName : "N/A";
  }
  return prod;
};

export const MapUserResponse = async (productDetails: any, updateDetails: any, cronSettingsResponse: any) => {
  // let data = {};
  productDetails.cronId = productDetails.cronId;
  productDetails.cronName = productDetails.CronName ? productDetails.CronName : productDetails.cronName;
  ...
  productDetails.allowReprice = updateDetails.Reprice_on_off == "on" ? true : false;
  productDetails.requestInterval = updateDetails.requestInterval ? updateDetails.requestInterval : 1; //Defaulted
  productDetails.floorPrice = parseFloat(productDetails.floorPrice);
  productDetails.net32url = productDetails.net32_url ? productDetails.net32_url : productDetails.net32url;
  productDetails.mpid = productDetails.mpid;
  productDetails.focusId = updateDetails.focus_id ? updateDetails.focus_id : null; //Defaulted
  ...
  productDetails.suppressPriceBreak = updateDetails.suppressPriceBreak == "on" ? true : false;
  productDetails.requestIntervalUnit = updateDetails.request_interval_unit ? updateDetails.request_interval_unit : "min"; //Defaulted
  ...
  productDetails.suppressPriceBreakForOne = updateDetails.suppressPriceBreakForOne == "on" ? true : false;
  productDetails.beatQPrice = updateDetails.beatQPrice == "on" ? true : false;
  productDetails.percentageIncrease = updateDetails.percentageIncrease ? parseFloat(updateDetails.percentageIncrease) : 0;
  productDetails.compareWithQ1 = updateDetails.compareWithQ1 == "on" ? true : false;
  productDetails.wait_update_period = true; //Defaulted
  productDetails.badgeIndicator = productDetails.badgeIndicator;
  productDetails.badgePercentage = updateDetails.badgePercentage ? parseFloat(updateDetails.badgePercentage) : 0;
  ...
  productDetails.includeInactiveVendors = updateDetails.includeInactiveVendors == "on" ? true : false;
  productDetails.override_bulk_update = updateDetails.override_bulk_update == "on" ? true : false;
  productDetails.override_bulk_rule = updateDetails.override_bulk_rule_select ? parseInt(updateDetails.override_bulk_rule_select) : 2;
  productDetails.latest_price = updateDetails.latest_price ? parseFloat(updateDetails.latest_price) : 0;
  productDetails.executionPriority = updateDetails.executionPriority ? parseInt(updateDetails.executionPriority) : updateDetails.executionPriority;
  productDetails.applyBuyBoxLogic = updateDetails.applyBuyBox == "on" ? true : false;
  productDetails.applyNcForBuyBox = updateDetails.applyNcForBuyBox == "on" ? true : false;
  productDetails.handlingTimeFilter = updateDetails.handling_time_filter;
  productDetails.keepPosition = updateDetails.keepPosition == "on" ? true : false;
  productDetails.excludedVendors = updateDetails.excludedVendors;
  productDetails.inventoryThreshold = !isNaN(parseInt(updateDetails.inventoryThreshold)) ? parseInt(updateDetails.inventoryThreshold) : 0;
  productDetails.percentageDown = !isNaN(parseFloat(updateDetails.percentageDown)) ? parseFloat(updateDetails.percentageDown) : 0;
  productDetails.badgePercentageDown = !isNaN(parseFloat(updateDetails.badgePercentageDown)) ? parseFloat(updateDetails.badgePercentageDown) : 0;
  productDetails.competeWithNext = updateDetails.competeWithNext == "on" ? true : false;
  productDetails.ignorePhantomQBreak = updateDetails.ignorePhantomQBreak == "on" ? true : false;
  productDetails.ownVendorThreshold = !isNaN(parseInt(updateDetails.ownVendorThreshold)) ? parseInt(updateDetails.ownVendorThreshold) : 1;
  productDetails.getBBBadgeValue = !isNaN(parseInt(updateDetails.getBBBadgeValue)) ? parseFloat(updateDetails.getBBBadgeValue) : 0.1;
...
export const MapFormData = async (productDetails: any, formData: any, formVendorData: any) => {
  ...
  productDetails.allowReprice = formVendorData.Reprice_on_off == "on" ? true : false;
  productDetails.requestInterval = formVendorData.requestInterval ? formVendorData.requestInterval : 1; //Defaulted
  ...
  productDetails.focusId = formVendorData.focus_id ? formVendorData.focus_id : null; //Defaulted
  ...
  productDetails.suppressPriceBreak = formVendorData.suppressPriceBreak == "on" ? true : false;
  productDetails.requestIntervalUnit = formVendorData.request_interval_unit ? formVendorData.request_interval_unit : "min"; //Defaulted
  productDetails.priority = formVendorData.priority ? formVendorData.priority : 5; //Defaulted
  productDetails.competeAll = formVendorData.competeAll == "on" ? true : false;
  productDetails.suppressPriceBreakForOne = formVendorData.suppressPriceBreakForOne == "on" ? true : false;
  productDetails.beatQPrice = formVendorData.beatQPrice == "on" ? true : false;
  productDetails.percentageIncrease = formVendorData.percentageIncrease ? parseFloat(formVendorData.percentageIncrease) : 0;
  productDetails.compareWithQ1 = formVendorData.compareWithQ1 == "on" ? true : false;
  productDetails.wait_update_period = true; //Defaulted
  productDetails.badgeIndicator = formVendorData.badgeIndicator;
  productDetails.badgePercentage = formVendorData.badgePercentage ? parseFloat(formVendorData.badgePercentage) : 0;
  productDetails.abortDeactivatingQPriceBreak = true; //Defaulted
  productDetails.ownVendorId = formVendorData.ownVendorId ? formVendorData.ownVendorId : null;
  ...
  productDetails.includeInactiveVendors = formVendorData.includeInactiveVendors == "on" ? true : false;
  productDetails.override_bulk_update = formVendorData.override_bulk_update == "on" ? true : false;
  productDetails.override_bulk_rule = formVendorData.override_bulk_rule_select ? parseInt(formVendorData.override_bulk_rule_select) : 2;
  productDetails.latest_price = formVendorData.latest_price ? parseFloat(formVendorData.latest_price) : 0;
  productDetails.executionPriority = formVendorData.executionPriority ? parseInt(formVendorData.executionPriority) : formVendorData.executionPriority;
  productDetails.applyBuyBoxLogic = formVendorData.applyBuyBox == "on" ? true : false;
  productDetails.applyNcForBuyBox = formVendorData.applyNcForBuyBox == "on" ? true : false;
  productDetails.handlingTimeFilter = formVendorData.handling_time_filter;
  productDetails.keepPosition = formVendorData.keepPosition == "on" ? true : false;
  productDetails.ownVendorThreshold = formVendorData.ownVendorThreshold ? parseInt(formVendorData.ownVendorThreshold) : 1;
  productDetails.getBBBadgeValue = !isNaN(parseInt(formVendorData.getBBBadgeValue)) ? parseFloat(formVendorData.getBBBadgeValue) : 0.1;
  productDetails.getBBShippingValue = !isNaN(parseInt(formVendorData.getBBShippingValue)) ? parseFloat(formVendorData.getBBShippingValue) : 0.005;
  productDetails.getBBBadge = formVendorData.getBBBadge == "on" ? true : false;
  productDetails.getBBShipping = formVendorData.getBBShipping == "on" ? true : false;
  return productDetails;
};
export const AlignCronName = async (productList: any) => {
  ...
  for (var product of productList) {
    if (!_.includes(alignedProduct, product.mpid)) {
      const listOfRelatedProducts = productList.find((x: any) => x.mpid == product.mpid && x.channelName.toLowerCase() != product.channelName.toLowerCase());
          ...
          _.forEach($l, (x) => {
            if (x.logs && x.logs.length > 0) {
              if (x.logs == error_one || x.logs == error_two) {
                const report = new FailedReport(x.productId, x.vendor, x.logs, $.cronId, moment(new Date($.time)).format("DD-MM-YY HH:mm:ss") as any);
...
export const AlignProducts = async (product: any, allCronList: any, slowCronIds: any) => {
  ...
  const dbProductDetailsArray = await mySqlUtility.GetFullProductDetailsById(parseInt(product.mpId as any)); //await mongoUtility.FindProductById(product.mpId);
  ...
  if (dbProductDetails) {
    ...
    const dbSlowCronId = dbProductDetails.isSlowActivated == true ? getContextItem(dbProductDetails, "slowCronId") : null;
    const dbSlowCronName = dbProductDetails.isSlowActivated == true ? getContextItem(dbProductDetails, "slowCronName") : null;
...
export const GetAlternateProxyProviderId = async (details: any, sequence: any) => {
  if (details.AlternateProxyProvider) {
    const linkedProvider = details.AlternateProxyProvider.find((x: any) => x.Sequence == sequence);
...
export const GetIsStepReached = async (details: any, stepCount: any) => {
  if (details.AlternateProxyProvider) {
    const listOfThresholdProvider = _.find(details.AlternateProxyProvider, (x: any) => x.Sequence == stepCount);
    return listOfThresholdProvider && listOfThresholdProvider.ProxyProvider == details.ProxyProvider;
  }
  return false;
};

export const MapAlternateProxyProviderDetails = async (idx: any, payload: any) => {
  let alternateResults: any[] = [];
  for (let i = 1; i <= 6; i++) {
    let info: any = {};
    info.Sequence = i;
    const keyToGetValue = idx == 999 ? `proxy_provider_422_alternate_${i}` : `proxy_provider_${i}`;
    info.ProxyProvider = idx == 999 ? parseInt(payload[keyToGetValue]) : parseInt(payload[keyToGetValue][idx]);
...
export const MapLatestPriceInfo = async (scrapeList: any, focusId: any) => {
  ...
  if (contextPriceInfo && contextPriceInfo.length > 0) {
    ...
    if (competitorPriceInfo && competitorPriceInfo.length > 0) {
      ...
      var scrapeInfo = new LatestScrapeInfo(_.first(competitorPriceInfo), focusId);
      return scrapeInfo;
    }
  }
  return null;
...
export const UpsertProductDetailsInSql = async (payload: any, mpid: any, req: any) => {
  ...
  await mySqlUtility.UpsertProductDetailsV2(new MySqlProduct(payload, sqlProductDetails, mpid, AuditInfo));
};
export const GetAlternateProxyProviderName = async (details: any, providerId: any) => {
  if (details && details.length > 0) {
    const linkedProvider = details.find((x: any) => x.proxyProvider == providerId);

    return linkedProvider ? (linkedProvider.method ? `${linkedProvider.proxyProviderName} - ${linkedProvider.method}` : `${linkedProvider.proxyProviderName}`) : null;
  }
  return "";
};
...
function getMappedDetails(product: any, fieldName: any) {
  let res = "";
  const keyValue = itemMapper.find((x) => x.field.toLowerCase() == fieldName.toLowerCase())!.key;
  if (product.tradentDetails) {
...
function parseBadgeIndicator(stringValue: any, evalType: any) {
  if (_.isEqual(evalType, "KEY")) {
    const $eval = badgeResx.find((x) => _.isEqual(x.key, stringValue.trim().toUpperCase()));
    return $eval && $eval.value ? $eval.value.trim() : (_.first(badgeResx) as any).value.trim();
...
function mapUserDataToDbData(userData: any, dbData: any, AuditInfo: any) {
  userData.lastCronTime = dbData.last_cron_time ? moment(dbData.last_cron_time).format("YYYY-MM-DD HH:mm:ss") : null;
  userData.lastCronRun = dbData.lastCronRun;
  userData.lastUpdateTime = dbData.last_update_time ? moment(dbData.last_update_time).format("YYYY-MM-DD HH:mm:ss") : null;
  ...
  userData.lastAttemptedTime = dbData.last_attempted_time ? moment(dbData.last_attempted_time).format("YYYY-MM-DD HH:mm:ss") : null;
  ...
  userData.nextCronTime = dbData.next_cron_time ? moment(dbData.next_cron_time).format("YYYY-MM-DD HH:mm:ss") : null;
  userData.slowCronName = userData.isSlowActivated == true ? dbData.slowCronName : null;
  userData.slowCronId = userData.isSlowActivated == true ? dbData.slowCronId : null;
  userData.isSlowActivated = userData.isSlowActivated == true ? dbData.isSlowActivated : userData.isSlowActivated;
  userData.lastUpdatedByUser = AuditInfo.UpdatedBy;
  userData.lastUpdatedOn = moment(AuditInfo.UpdatedOn).format("YYYY-MM-DD HH:mm:ss");
  return userData;
}
