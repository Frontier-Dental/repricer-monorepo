...
export const GetLatestRunInfoForCron = async (
  noOfRecords: any,
  startDateTime: any,
  endDateTime: any,
  cronId: any,
...
export const GetNumberOfScrapeProducts = async () => {
...
export const GetScrapeProductList = async (pageNumber: any, pageSize: any) => {
...
export const GetScrapeProductListByFilter = async (
  filterText: any,
  pageSize: any,
  pageNumber: any,
) => {
...
export const UpsertProductDetails = async (payload: any) => {
...
export const DeleteScrapeProductById = async (mpId: any) => {
  let noOfRecords: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const GetLastScrapeDetailsById = async (mpId: any) => {
...
export const UpsertVendorData = async (payload: any, vendorName: any) => {
  let upsertResult: any = null;
  const db = await SqlConnectionPool.getConnection();
...
export const UpsertProductDetailsV2 = async (payload: any) => {
  let upsertResult: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const GetCompleteProductDetails = async () => {
  let scrapeDetails: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const GetNumberOfRepriceEligibleProductCount = async () => {
  let noOfRecords: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const GetAllRepriceEligibleProductByFilter = async (
  pageNumber: any,
  pageSize: any,
) => {
  let scrapeDetails: any = null;
...
export const GetAllRepriceEligibleProductByTag = async (filterTag: any) => {
  let scrapeDetails: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const GetFullProductDetailsById = async (mpid: any) => {
...
export const UpdateVendorData = async (payload: any, vendorName: any) => {
  let upsertResult: any = null;
  const db = await SqlConnectionPool.getConnection();
  let contextSpName: any = null;
  switch (vendorName) {
...
export const GetLinkedVendorDetails = async (mpId: any, vendorName: any) => {
  try {
    let noOfRecords: any = null;
    const db = await SqlConnectionPool.getConnection();
...
export const UpdateProductV2 = async (
  mpid: any,
  itemData: any,
  tId: any,
  fId: any,
...
export const ChangeProductActivation = async (mpid: any, status: any) => {
  let noOfRecords: any = null;
  const db = await SqlConnectionPool.getConnection();
  try {
...
export const MapVendorToRoot = async (data: any) => {
  try {
...
export const ToggleDataScrapeForId = async (
  mpid: any,
  status: any,
  auditInfo: any,
) => {
...
export const UpdateBranchDataForVendor = async (
  mpId: any,
  vendorName: any,
  payLoad: any,
) => {
...
export const ExecuteQuery = async (_query: any, _params: any) => {
  try {
    let noOfRecords: any = null;
    const db = await SqlConnectionPool.getConnection();
    try {
