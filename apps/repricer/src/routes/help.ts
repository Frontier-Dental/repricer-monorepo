...
helpRouter.get("/ip_health_check", authMiddleware, helpController.doIpHealthCheck);
...
helpRouter.get("/updateSecretKey", authMiddleware, helpController.updateCronSecretKey);

helpRouter.get("/create_cron/:count", authMiddleware, helpController.createCrons);
helpRouter.get("/align_execution_priority", authMiddleware, helpController.alignExecutionPriority);
helpRouter.get("/getProductDetailsById/:id", AuthToken, helpController.getProductDetails);

helpRouter.post("/migrate/cron-settings", AuthToken, helpController.migrateCronSettingsToSql);
