...
productV2Router.post("/simulateManualReprice/:id", productV2Controller.simulateManualReprice);
...
productV2Router.get("/load_initial_product/:id", productV2Controller.collateProductsForId);
...
productV2Router.post("/update_product_V2", productV2Controller.updateProductDetails);
productV2Router.post("/save_branches", productV2Controller.saveBranches);
productV2Router.post("/activate_all", productV2Controller.activateProductForAll);
productV2Router.post("/deactivate_all", productV2Controller.deActivateProductForAll);
productV2Router.post("/save/download_excel", productV2Controller.exportItems);
productV2Router.post("/toggle_data_scrape", productV2Controller.toggleDataScrape);
productV2Router.post("/save_rootDetails", productV2Controller.saveRootDetails);
productV2Router.get("/runManualSync", productV2Controller.runManualSyncOfProducts);
productV2Router.post("/removeFrom422", productV2Controller.removeFrom422);
productV2Router.get("/removeFrom422ForAll", productV2Controller.removeFrom422ForAll);
