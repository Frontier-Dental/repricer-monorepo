...
productRouter.post("/delete_item", productController.deleteMasterItemController);
productRouter.post("/update_item_post", productController.updateMasterItemController);
...
productRouter.get("/get_all_active_products", productController.getAllActiveProducts);
