...
v2AlgoRouter.get("/get_algo_results_with_execution/:mpId", getAlgoResultsWithExecution);
...
v2AlgoRouter.put("/update_algo_execution_mode/:mpId", updateAlgoExecutionModeController);

// Get algo_execution_mode status
v2AlgoRouter.get("/get_algo_execution_mode/:mpId", getAlgoExecutionModeController);
...
v2AlgoRouter.get("/get_all_products_with_algo_data", getAllProductsWithAlgoDataController);

// Toggle enabled status for specific mp_id and vendor_id
v2AlgoRouter.put("/toggle_enabled/:mpId/:vendorId", toggleV2AlgoEnabledController);
